...
<meta http-equiv="imagetoolbar" content="false" />
  ...
  <script src="/javascripts/underscore.min.js?1589925922" type="text/javascript"></script>
  <script>
    Mkiconf = window.Mkiconf || {}; Mkiconf.authenticity_token = "gBke0TPFxz5pKAmKmWjA697sk/cG+DdFQA0yUZ7yizE=";
  </script>
  <script src="/javascripts/application.min.js?1610550674" type="text/javascript"></script>
  <script src="/javascripts/json2.min.js?1589925922" type="text/javascript"></script>

<script type='text/javascript'>
  Mkiconf = window.Mkiconf || {};
  Mkiconf.template_path = "/templates/application.html?mtime=1589925927";
</script>

<link href="/stylesheets/corpweb/style.css?1589925933" media="all" rel="stylesheet" type="text/css" />
<link href="/stylesheets/minified/common_only.css?1589995267" media="all" rel="stylesheet" type="text/css" />
<link href="/stylesheets/minified/login.css?1589995267" media="all" rel="stylesheet" type="text/css" />
  <style type="text/css">
    .notice_explanation {
      padding:1em 1em;
      margin-bottom:0.5em;
  ...
  <div style='min-width:450px;max-width:750px;margin:auto;'>
    <div id="login_header">
      <a href="http://meraki.com/">
          <img alt="Cisco Systems, Inc." border="0" src="/images/cisco-meraki.png?1589925929" style="width: 165px;margin-bottom:10px" />
      </a>
      <div id="m_nav">
      </div>
    </div>
...
<div id='login_form' style='float: right; border: solid 1px grey; padding: 1em; margin: 2em; width: 260px;'>
  <form accept-charset="UTF-8" action="https://account.network-auth.com/account/do_account_login" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="gBke0TPFxz5pKAmKmWjA697sk/cG+DdFQA0yUZ7yizE=" /></div>
    <center>
...
$(document).ready(orginit)
    ...
    <div style="margin-top: 8px">
      <a href="https://account.network-auth.com/account/reset_account_password">I forgot my password</a>
    </div>
