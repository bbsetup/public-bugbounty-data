...
<meta http-equiv="imagetoolbar" content="false" />
  ...
  <script>
    Mkiconf = window.Mkiconf || {}; Mkiconf.authenticity_token = "MmsnIpNOW4hdtk9xFI2AZ4jgTNF6gx1jGJsVAcnewJI=";
  </script>
...
<div id='login_form' style='float: right; border: solid 1px grey; padding: 1em; margin: 2em; width: 260px;'>
  <form accept-charset="UTF-8" action="https://account.network-auth.com/account/do_account_login" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="MmsnIpNOW4hdtk9xFI2AZ4jgTNF6gx1jGJsVAcnewJI=" /></div>
    <center>
