...
<!--  -->
<script defer id='bilmur' data-provider='wordpress.com' data-service='atomic' src='https://s0.wp.com/wp-content/js/bilmur.min.js?m=202104'></script>
...
<script type="text/javascript">(function() {
			...
			}());</script><script src='https://stats.wp.com/e-202104.js' defer></script>
<script>
	_stq = window._stq || [];
