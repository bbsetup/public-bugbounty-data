...
<head>
  ...
  <script src="/javascripts/modernizr.min.js?1599837972" type="text/javascript"></script>
  <link href="/stylesheets/normalize.min.css?1599837978" media="all" rel="stylesheet" type="text/css" />
  <link href="/stylesheets/minified/dashboard_login.css?1599837978" media="all" rel="stylesheet" type="text/css" />
  <link href="/stylesheets/minified/login_promo.css?1599837978" media="all" rel="stylesheet" type="text/css" />
...
<div id="container">
  ...
  <header id="masthead">
    <div id="masthead-content">
      <a href="https://meraki.cisco.com/"><img alt="Cisco Meraki" src="/images/cisco-meraki.png?1599837969" width="165" /></a>
    </div>
  </header>
...
<div id="cookie_failure_container">
  <div class="notice_explanation_container">
    <div class="notice_explanation bad">Your browser must have cookies enabled to use Dashboard.</div>
          ...
          <form accept-charset="UTF-8" action="/login/email_lookup" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="WfiiJunwkZrT5Hv/mS3AScsJzw7XLpuJhiybZWaGjew=" /></div> 
          ...
          <div id="formarea-bottom" class="clearfix">
            <ul>
              ...
              <li><a href="https://account.sandbox.meraki.com/login/signup">Create an account</a></li>
            </ul>
          </div>
...
<div id="promo-box" class="column"><a href="https://meraki.cisco.com/products/sensors/?utm_source=dashboard&amp;utm_medium=referral&amp;utm_campaign=global_mt-launch-dashboard&amp;utm_content=dashboard-protect">
    <div classname="promo-item new_mt_protect">
      <img src="/images/dashboard_promo/meraki-sensors-dashboard-ad-1279x710-B.jpg" width="614" alt="New Meraki MT Models" />
    </div>
</a></div>
