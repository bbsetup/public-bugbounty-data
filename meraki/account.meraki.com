...
<meta http-equiv="imagetoolbar" content="false" />
  ...
  <script>
    Mkiconf = window.Mkiconf || {}; Mkiconf.authenticity_token = "l5ylO/w2Vbex3LX+6jNErsw/9x/ELavstMjEzo4q5Q0=";
  </script>
...
<div id='login_form' style='float: right; border: solid 1px grey; padding: 1em; margin: 2em; width: 260px;'>
  <form accept-charset="UTF-8" action="https://account.meraki.com/account/do_account_login" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="l5ylO/w2Vbex3LX+6jNErsw/9x/ELavstMjEzo4q5Q0=" /></div>
    <center>
...
$(document).ready(orginit)
    ...
    <div style="margin-top: 8px">
      <a href="https://account.meraki.com/account/reset_account_password">I forgot my password</a>
    </div>
