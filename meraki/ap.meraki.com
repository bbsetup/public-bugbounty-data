...
<div id="cookie_failure_container">
  <div class="notice_explanation_container">
    <div class="notice_explanation bad">Your browser must have cookies enabled to use Dashboard.</div>
          ...
          <form accept-charset="UTF-8" action="/login/email_lookup" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dKDeDRkVCfhRRzbsaZEP0HcmD90Qrcs8njoNrrtBib8=" /></div> 
...
<div id="promo-box" class="column"><a href="https://meraki.cisco.com/products/sensors/?utm_source=dashboard&amp;utm_medium=referral&amp;utm_campaign=global_mt-launch-dashboard&amp;utm_content=dashboard-realtime">
    <div classname="promo-item new_mt_real-time">
      <img src="/images/dashboard_promo/meraki-sensors-dashboard-ad-1279x710-D.jpg" width="614" alt="New Meraki MT Models" />
    </div>
</a></div>
