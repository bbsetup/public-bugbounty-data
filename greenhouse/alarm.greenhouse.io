...
<head>
    ...
    <title>Alarm.com - Sign In</title>
        <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="robots" content="none" />
    <script src="https://alarm.okta.com/assets/js/sdk/okta-signin-widget/5.2.1/js/okta-sign-in.min.js" type="text/javascript"></script>
    <link href="https://alarm.okta.com/assets/js/sdk/okta-signin-widget/5.2.1/css/okta-sign-in.min.css" type="text/css" rel="stylesheet"/>
    <link href="https://alarm.okta.com/assets/loginpage/css/loginpage-theme.7138a0eb969c6a25c2d39004ad54df8a.css" type="text/css" rel="stylesheet"/><script>
        var okta = {
            locale: 'en',
            deployEnv: 'PROD'
        };
...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;app&#x2f;greenhouse&#x2f;exk1g38p96l0dih7n0h8&#x2f;sso&#x2f;saml&#x3f;SAMLRequest&#x3d;fZJNa4MwGMe&#x25;2FirecNMa6aUMtSMug0I3RvRx2GWn6WEM1cXni7L791DLajW2nQPi&#x25;2F8UtmKOqq4XnrSr2BtxbQeTkiWKeMXhiNbQ32Aey7kvC0WWekdK5BTqmohK2DvQXQpWkRAmVof1ikQyKVJyvxln2i0mKI&#x25;2B2k2BycCaWoqmoaekygcD2w&#x25;2FSZvpdRXuVJnosEwpohmTibdaZuR1m0SiSGHrT6cs9mNIhb9lSexLJuNCTJNiF0a9FLGFlUYntMtIFEbMD5kfTR5Dxq8iPkleiPfcbx7HRUFIvGNdaeRDUUZaq7kRqJBrUQNyJ&#x25;2FlDfrvmvZCLL0aXluZ&#x25;2FT2ONM9JUZD4b1HxcZ&#x25;2BcDlJ5J13VnIr8hmNFL1&#x25;2Bz0cHd9y2p5byolP7y8qky3sCAcZMTZtsd&#x25;2FY2wt3N&#x25;2B7WMDGG7Xzi1HKW40NSFUo2BE6P5V&#x25;2B&#x25;2FyDzTw&#x25;3D&#x25;3D&amp;RelayState&#x3d;4000962002"/>
</form>
          ...
          <div class="applogin-container">
              <h1>
                Connecting to<div class="applogin-app-logo">
                      <img src="https://alarm.okta.com/fs/bcg/4/gfs1iyt8gteLwOy0z0h8" alt="Greenhouse" class="logo greenhouse"/></div>
              </h1>
              <p>Sign-in with your Alarm.com account to access Greenhouse</p>
          </div>
      </div>
  <style type="text/css">
    .noscript-msg {
...
<script type="text/javascript">function runLoginPage (fn) {var mainScript = document.createElement('script');mainScript.src = 'https://alarm.okta.com/assets/js/mvc/loginpage/initLoginPage.pack.bb0aa11a63d230e8b135b92ba459ee7e.js';mainScript.crossOrigin = 'anonymous';mainScript.integrity = 'sha384-pigRdMXEy7yI9Qz6y9AVg1Gevie0LwAPvv7OUKRG7ZKz9B5H/Zgdl1Bm5onnwxa0';document.getElementsByTagName('head')[0].appendChild(mainScript);fn && mainScript.addEventListener('load', function () { setTimeout(fn, 1) });}</script><script type="text/javascript">
(function(){

  var baseUrl = 'https\x3A\x2F\x2Falarm.okta.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Fapp\x2Fgreenhouse\x2Fexk1g38p96l0dih7n0h8\x2Fsso\x2Fsaml\x3FSAMLRequest\x3DfZJNa4MwGMe\x252FirecNMa6aUMtSMug0I3RvRx2GWn6WEM1cXni7L791DLajW2nQPi\x252F8UtmKOqq4XnrSr2BtxbQeTkiWKeMXhiNbQ32Aey7kvC0WWekdK5BTqmohK2DvQXQpWkRAmVof1ikQyKVJyvxln2i0mKI\x252B2k2BycCaWoqmoaekygcD2w\x252FSZvpdRXuVJnosEwpohmTibdaZuR1m0SiSGHrT6cs9mNIhb9lSexLJuNCTJNiF0a9FLGFlUYntMtIFEbMD5kfTR5Dxq8iPkleiPfcbx7HRUFIvGNdaeRDUUZaq7kRqJBrUQNyJ\x252FlDfrvmvZCLL0aXluZ\x252FT2ONM9JUZD4b1HxcZ\x252BcDlJ5J13VnIr8hmNFL1\x252Bz0cHd9y2p5byolP7y8qky3sCAcZMTZtsd\x252FY2wt3N\x252B7WMDGG7Xzi1HKW40NSFUo2BE6P5V\x252B\x252FyDzTw\x253D\x253D\x26RelayState\x3D4000962002';
  var username = '';
  var rememberMe = true;
  ...
  var helpLabel = 'Help';
  var orgSupportPhoneNumber = '571\x2D327\x2D8361';
  ...
  var signOutUrl = 'https\x3A\x2F\x2Falarm.okta.com\x2Flogin\x2Fdefault';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://alarm.okta.com/fs/bco/1/fs0wm2p80hRSFJFVPTGI',
      logoText: 'Alarm.com logo',
      ...
      assets: {
        baseUrl: "https\x3A\x2F\x2Falarm.okta.com\x2Fassets\x2Fjs\x2Fsdk\x2Fokta\x2Dsignin\x2Dwidget\x2F5.2.1"
      },
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://alarm.okta.com/fs/bco/7/fs019rttmz71DNac90h8')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://alarm.okta.com/fs/bco/7/fs019rttmz71DNac90h8', sizingMethod='scale')");
  });
</script>
