```<!--googleoff: all-->
<html lang="en"><head><title>admin-green-qa.youtube.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="hi0rGAH1BSSSEeIFOjbChQ">
        
      </script>
<script type="text/javascript" nonce="hi0rGAH1BSSSEeIFOjbChQ">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="admin-green-qa.youtube.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://admin-green-qa.youtube.com/?upxsrf=AO9zFu2s5FJV6hWmFzfAAsyJRzc1n2cvFNp0bJRIacYN8-S82g:1611352542788"/>
...
<input type="hidden" id="x" name="x" value="x:ChgIzsy5yv7hypMnEJGd4uDyLhiRneLg8i4SJQDmqPmOR5y7J1U_ueiLZZFQmJ6Eq8Z0iasTtCVns-jr-e1Y7rw"/>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=admin-green-qa.youtube.com:443/uberproxy/&amp;d=https://admin-green-qa.youtube.com/?upxsrf%3DAO9zFu2s5FJV6hWmFzfAAsyJRzc1n2cvFNp0bJRIacYN8-S82g:1611352542788&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="hi0rGAH1BSSSEeIFOjbChQ">
