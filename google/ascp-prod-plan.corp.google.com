```<!--googleoff: all-->
<html lang="en"><head><title>ascp-prod-plan.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="Huqt004Sbv4X5MbJvoG/KQ">
        
      </script>
<script type="text/javascript" nonce="Huqt004Sbv4X5MbJvoG/KQ">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-prod-plan.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-prod-plan.corp.google.com/?upxsrf=AO9zFu3d8xiuswZNkB3F9lRMvrj-wiLytvekTHuz2hQghxnXEA:1611721992387"/>
...
<input type="hidden" id="x" name="x" value="x:ChgI7fyakoq_1JEIEMnS95D0LhjJ0veQ9C4SJQDmqPmOyz_GMR46Y4q3hfp7HNRStHqhhOo7MGiAEasXa0GOsVM"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/I95_from_Providence_Place-sso-jeffb.jpg" width="400" height="266" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-prod-plan.corp.google.com:443/uberproxy/&amp;d=https://ascp-prod-plan.corp.google.com/?upxsrf%3DAO9zFu3d8xiuswZNkB3F9lRMvrj-wiLytvekTHuz2hQghxnXEA:1611721992387&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="Huqt004Sbv4X5MbJvoG/KQ">
