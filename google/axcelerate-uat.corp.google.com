```<!--googleoff: all-->
<html lang="en"><head><title>axcelerate-uat.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="wpzeqjYAyPVIyE5C6ftkow">
        
      </script>
<script type="text/javascript" nonce="wpzeqjYAyPVIyE5C6ftkow">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="axcelerate-uat.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://axcelerate-uat.corp.google.com/?upxsrf=AO9zFu1CShSxCLc5HcWrvzY_mQAYJJGRAF30ghoyl30waW16bg:1611746539530"/>
...
<input type="hidden" id="x" name="x" value="x:ChkIwIXO846rj8jlARCA8dGc9C4YgPHRnPQuEiUA5qj5js5Xkl3w46d62KqaONFg4NvxfSIcAp4tJABa_69KgfqC"/>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=axcelerate-uat.corp.google.com:443/uberproxy/&amp;d=https://axcelerate-uat.corp.google.com/?upxsrf%3DAO9zFu1CShSxCLc5HcWrvzY_mQAYJJGRAF30ghoyl30waW16bg:1611746539530&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="wpzeqjYAyPVIyE5C6ftkow">
