```<!--googleoff: all-->
<html lang="en"><head><title>ascp-sbx-wlsadm-fs1.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="fhgNi9OZQCwmJu169aif9A">
        
      </script>
<script type="text/javascript" nonce="fhgNi9OZQCwmJu169aif9A">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-sbx-wlsadm-fs1.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-sbx-wlsadm-fs1.corp.google.com/?upxsrf=AO9zFu2j8ASqbHbf2X7imLBFwsNxLi2Hb-rq0stJy24iq-P1rA:1611721990139"/>
...
<input type="hidden" id="x" name="x" value="x:ChkI5YbjheyEtJG4ARDvwPeQ9C4Y78D3kPQuEiUA5qj5jtBRV9Cu25Eu_vjStdR1A1tZ8WO8SPuxKyYMBUGbNq7P"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/WelcomeNerds.jpg" width="400" height="269" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-sbx-wlsadm-fs1.corp.google.com:443/uberproxy/&amp;d=https://ascp-sbx-wlsadm-fs1.corp.google.com/?upxsrf%3DAO9zFu2j8ASqbHbf2X7imLBFwsNxLi2Hb-rq0stJy24iq-P1rA:1611721990139&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="fhgNi9OZQCwmJu169aif9A">
