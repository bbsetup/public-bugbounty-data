```<!--googleoff: all-->
<html lang="en"><head><title>ascp-prod-wlsadm-fs2.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="mCzECRtJgS2B0My7LXULMQ">
        
      </script>
<script type="text/javascript" nonce="mCzECRtJgS2B0My7LXULMQ">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-prod-wlsadm-fs2.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-prod-wlsadm-fs2.corp.google.com/?upxsrf=AO9zFu02zXuAqVhs4lCRP2mPaeNRQzi76Y01jim7KxSwLKyD7Q:1611721987839"/>
...
<input type="hidden" id="x" name="x" value="x:ChkIwojB-KHs3P_YARD4rveQ9C4Y-K73kPQuEiUA5qj5jr40BBQIWVuSoAQvsubRM1z_q7tO3jFjqWNvJsfYf82z"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/kevinskitchen.jpg" width="427" height="320" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-prod-wlsadm-fs2.corp.google.com:443/uberproxy/&amp;d=https://ascp-prod-wlsadm-fs2.corp.google.com/?upxsrf%3DAO9zFu02zXuAqVhs4lCRP2mPaeNRQzi76Y01jim7KxSwLKyD7Q:1611721987839&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="mCzECRtJgS2B0My7LXULMQ">
