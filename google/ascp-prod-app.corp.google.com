```<!--googleoff: all-->
<html lang="en"><head><title>ascp-prod-app.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="eXsGcxczvRkKo3JQXWJOcg">
        
      </script>
<script type="text/javascript" nonce="eXsGcxczvRkKo3JQXWJOcg">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-prod-app.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-prod-app.corp.google.com/?upxsrf=AO9zFu0TerQUoGbYwDcOzTaRu2mFQIo5LB3I7c7ROuFm9GuK0Q:1611721975059"/>
...
<input type="hidden" id="x" name="x" value="x:ChkIhMqfrM_dr5v2ARCYy_aQ9C4YmMv2kPQuEiUA5qj5jiMi2qV3js1WE1zfppnXZBS79phSNE9dsHPWNYBhSK2i"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/adsouza_autumn_leaf.jpg" width="400" height="300" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-prod-app.corp.google.com:443/uberproxy/&amp;d=https://ascp-prod-app.corp.google.com/?upxsrf%3DAO9zFu0TerQUoGbYwDcOzTaRu2mFQIo5LB3I7c7ROuFm9GuK0Q:1611721975059&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="eXsGcxczvRkKo3JQXWJOcg">
