```<!--googleoff: all-->
<html lang="en"><head><title>ascp-prod-wlsadm-plan.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="PW6UOHbr0gb64v4oVsk/fw">
        
      </script>
<script type="text/javascript" nonce="PW6UOHbr0gb64v4oVsk/fw">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-prod-wlsadm-plan.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-prod-wlsadm-plan.corp.google.com/?upxsrf=AO9zFu21V-M3AT9XqaASx92LqfToFrxAC4r4L-DS3SOwyz88hw:1611721991312"/>
...
<input type="hidden" id="x" name="x" value="x:ChgI-bW-2Z-fgecYEIXK95D0LhiFyveQ9C4SJQDmqPmOWQoPzsxrModcNiNyS7NnidHO9wR3QsVQtwBgaaxVQII"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/parisspiral.jpg" width="400" height="300" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-prod-wlsadm-plan.corp.google.com:443/uberproxy/&amp;d=https://ascp-prod-wlsadm-plan.corp.google.com/?upxsrf%3DAO9zFu21V-M3AT9XqaASx92LqfToFrxAC4r4L-DS3SOwyz88hw:1611721991312&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="PW6UOHbr0gb64v4oVsk/fw">
