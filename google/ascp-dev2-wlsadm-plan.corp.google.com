```<!--googleoff: all-->
<html lang="en"><head><title>ascp-dev2-wlsadm-plan.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="H+q7BbuG9fGUAhVgh9eNMw">
        
      </script>
<script type="text/javascript" nonce="H+q7BbuG9fGUAhVgh9eNMw">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-dev2-wlsadm-plan.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-dev2-wlsadm-plan.corp.google.com/?upxsrf=AO9zFu3FlwJjIZlQQ85LlJjDHM7terAios-m8vGXtTrU3u3ayg:1611721955775"/>
...
<input type="hidden" id="x" name="x" value="x:ChgIz_SSq5P6ysRKELO09ZD0LhiztPWQ9C4SJQDmqPmOmEv9epGLyCPRzBdZqQWlel9ZK-7vY-NgQqN8dgV7vXM"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/DSCF1150.jpg" width="400" height="300" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-dev2-wlsadm-plan.corp.google.com:443/uberproxy/&amp;d=https://ascp-dev2-wlsadm-plan.corp.google.com/?upxsrf%3DAO9zFu3FlwJjIZlQQ85LlJjDHM7terAios-m8vGXtTrU3u3ayg:1611721955775&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="H+q7BbuG9fGUAhVgh9eNMw">
