```<!--googleoff: all-->
<html lang="en"><head><title>ascp-dev2-app.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="nausLEFQtL3b01OYpDNblw">
        
      </script>
<script type="text/javascript" nonce="nausLEFQtL3b01OYpDNblw">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-dev2-app.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-dev2-app.corp.google.com/?upxsrf=AO9zFu2ADIgA42Mb5cqDRDyLo-deduvQVLH_9qps37In1Ys3xA:1611721953489"/>
...
<input type="hidden" id="x" name="x" value="x:ChkIzbOL1dj57-GoARDHovWQ9C4Yx6L1kPQuEiUA5qj5joBgcQxNBY5Gyp7USFW2bmRZOrujT-g8ejKYtRl35TC3"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/whatis.jpg" width="400" height="300" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-dev2-app.corp.google.com:443/uberproxy/&amp;d=https://ascp-dev2-app.corp.google.com/?upxsrf%3DAO9zFu2ADIgA42Mb5cqDRDyLo-deduvQVLH_9qps37In1Ys3xA:1611721953489&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="nausLEFQtL3b01OYpDNblw">
