```<!--googleoff: all-->
<html lang="en"><head><title>ascp-dev1-plan.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="x73iauWGgKGZmbUNDBLwvQ">
        
      </script>
<script type="text/javascript" nonce="x73iauWGgKGZmbUNDBLwvQ">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-dev1-plan.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-dev1-plan.corp.google.com/?upxsrf=AO9zFu13BNf-uKacvVmPLBlVtSS-jQlJI-cxPEmEg8TI0DkOhg:1611721943903"/>
...
<input type="hidden" id="x" name="x" value="x:ChgIy-DUxsnI5esOENfX9JD0LhjX1_SQ9C4SJQDmqPmOTaRIYUOYKj4nrGHH84SErOKelt9Iaq4iWMdEuAGXdn8"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/p1000772bldg42c.jpg" width="400" height="300" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-dev1-plan.corp.google.com:443/uberproxy/&amp;d=https://ascp-dev1-plan.corp.google.com/?upxsrf%3DAO9zFu13BNf-uKacvVmPLBlVtSS-jQlJI-cxPEmEg8TI0DkOhg:1611721943903&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="x73iauWGgKGZmbUNDBLwvQ">
