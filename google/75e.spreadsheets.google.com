...
<div class="card signin-card
  ...
  <input type="hidden" name="gxf" value="AFoagUUGal3oAXwAg5IzfUbNdkJs14GSRQ:1611343491047">
  ...
  <input id="session-state" name="SessionState" type="hidden" value="AEThLlzB6Po3FkPKqaPxCki2LZCsSwCQ6tc8Cmb5E2HS0E94myODMJC5-mdXFmznwrmk2LeKj8qu_AuC5V3Lli7oHFFA-vcSqnanSVEDgybt0JwNQ2feAntvlD1bgUCYVoTRwrLJc4FMiKxWZBi5Ovo3downxHnierIH_hdr_oxZyGkIvKuFe31jcMx0Vf3t4Bk2TiF2LDXv">
...
<script type="text/javascript" nonce="FXsw4YfSI2/hvlgqGZClaQ">
...
<script nonce="FXsw4YfSI2/hvlgqGZClaQ">
  ...
  <script nonce="FXsw4YfSI2/hvlgqGZClaQ">var e=this,g=function(b,c){b=b.split(".");var a=e;b[0]in a||!a.execScript||a.execScript("var "+b[0]);for(var d;b.length&&(d=b.shift());)b.length||void 0===c?a[d]?a=a[d]:a=a[d]={}:a[d]=c};var h=function(){try{return new XMLHttpRequest}catch(a){for(var b=["MSXML2.XMLHTTP.6.0","MSXML2.XMLHTTP.3.0","MSXML2.XMLHTTP","Microsoft.XMLHTTP"],c=0;c<b.length;c++)try{return new ActiveXObject(b[c])}catch(d){}}return null};g("gaia.ajax.newXmlHttpRequest",h);var k=function(){this.g=h();this.parameters={}};
