```<!--googleoff: all-->
<html lang="en"><head><title>ascp-lnp-plan.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="4A/v8Fm5PpQq4p8J+18u1Q">
        
      </script>
<script type="text/javascript" nonce="4A/v8Fm5PpQq4p8J+18u1Q">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-lnp-plan.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-lnp-plan.corp.google.com/?upxsrf=AO9zFu163hltV1_Tvd3ndeqytcyCKZ0fwmzWFMiNfWImV7LvdQ:1611721973930"/>
...
<input type="hidden" id="x" name="x" value="x:ChkI3cj-3fDtheDdARCewvaQ9C4YnsL2kPQuEiUA5qj5jgzLLoGuyP66M1NN_YHQhRvcqGgQLMmuSfRPgoVzfudw"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/Osaka.jpg" width="400" height="300" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-lnp-plan.corp.google.com:443/uberproxy/&amp;d=https://ascp-lnp-plan.corp.google.com/?upxsrf%3DAO9zFu163hltV1_Tvd3ndeqytcyCKZ0fwmzWFMiNfWImV7LvdQ:1611721973930&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="4A/v8Fm5PpQq4p8J+18u1Q">
