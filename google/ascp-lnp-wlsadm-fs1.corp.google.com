```<!--googleoff: all-->
<html lang="en"><head><title>ascp-lnp-wlsadm-fs1.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="9XERLvK0IPnn54SSVo7+Bw">
        
      </script>
<script type="text/javascript" nonce="9XERLvK0IPnn54SSVo7+Bw">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-lnp-wlsadm-fs1.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-lnp-wlsadm-fs1.corp.google.com/?upxsrf=AO9zFu3dD6DTjbx0T0-a2mftSc5tGZwrsREHoUBUvxndWKsEeQ:1611721978441"/>
...
<input type="hidden" id="x" name="x" value="x:ChkIlrqB_pTw48SzARC_5faQ9C4Yv-X2kPQuEiUA5qj5jpI2iihBKr6zeLDaxKbg1yzggML99a0d7v8LVV1ikT18"/>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/ntrmarg3.jpg" width="400" height="300" alt="decorative image" /></div></td></tr></table></form>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=ascp-lnp-wlsadm-fs1.corp.google.com:443/uberproxy/&amp;d=https://ascp-lnp-wlsadm-fs1.corp.google.com/?upxsrf%3DAO9zFu3dD6DTjbx0T0-a2mftSc5tGZwrsREHoUBUvxndWKsEeQ:1611721978441&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=zRI,s8x,xSS,Caq"><img src="/c/balls.gif" border="0" alt="" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="9XERLvK0IPnn54SSVo7+Bw">
