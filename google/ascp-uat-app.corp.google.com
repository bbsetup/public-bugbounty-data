```<!--googleoff: all-->
<html lang="en"><head><title>ascp-uat-app.corp.google.com - MOMA Single Sign On</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="8YRQ0EEnzpHEBbrKap7OMA">
        
      </script>
<script type="text/javascript" nonce="8YRQ0EEnzpHEBbrKap7OMA">
...
<form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="ascp-uat-app.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://ascp-uat-app.corp.google.com/?upxsrf=AO9zFu1fXmiz25BP4OdlEo9iZgIniRiouGP19ccUW_mrxKphYA:1611722001503"/>
...
<input type="hidden" id="x" name="x" value="x:ChkIo7-r7MO02cuUARDUmfiQ9C4Y1Jn4kPQuEiUA5qj5jtweKnWG2kGvlag9cZB-dUEBPieijszEn3bHEMUBZR8c"/>
