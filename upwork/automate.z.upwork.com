...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;app&#x2f;upworkincprod_luminate_1&#x2f;exk1f2mth2uifyM7j1d8&#x2f;sso&#x2f;saml&#x3f;SAMLRequest&#x3d;fZLLbsMgEEXX&#x25;2FYvIe8eA8QvFllJl0UiNGrVWF95EgMeNmxhcg9X07&#x25;2BtHKqWbsAPOzNx7YWV4c27ZurdH9QpfPRi7uDRnZdh0kTp9p5jmpjZM8QYMs5K9rXfPjCwRaztttdRnZzGsh81QWytua61S52hta5jn9e237k5Sd&#x25;2B1SnyxfSt14vG2v57WSQ4&#x25;2FycO6bsRIO2IPLCVeksUfS19XPLvrEZewZo71RzzRou0mdg49oLEQSAi4hChFgTkiABEEgMNCAz6QxPWyVsVzZ1CGIYBdhl0Q5xgz5jITFhO2vNh5rVdbq475nMUOGPeX53t2&#x25;2FvOXO4h06M7keACdbjUrZNLu7yfJ&#x25;2BW24MdGN0TjZifHgPxP5iYUklMKFEVCIGCiXmNIq5H0JFZYmigLtznEVRyDCUAAF1OSTg0lhGbswT6lIhk7IM4gr8YOXdKMzm3f8vkP0C&amp;RelayState&#x3d;Jh0cA5MTQEEz86a7mvaw-BAZ37kVcXKY"/>
</form>
          ...
          <div class="applogin-container">
              <h1>
                Connecting to<div class="applogin-app-logo">
                      <img src="https://ok3static.oktacdn.com/fs/bco/4/fs01f2uvj9nqMfpvh1d8" alt="Luminate" class="logo upworkincprod_luminate_1"/></div>
              </h1>
              <p>Sign-in with your Upwork account to access Luminate</p>
          </div>
      </div>
  <style type="text/css">
    .noscript-msg {
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fupworkcorp.okta.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Fapp\x2Fupworkincprod_luminate_1\x2Fexk1f2mth2uifyM7j1d8\x2Fsso\x2Fsaml\x3FSAMLRequest\x3DfZLLbsMgEEXX\x252FYvIe8eA8QvFllJl0UiNGrVWF95EgMeNmxhcg9X07\x252BtHKqWbsAPOzNx7YWV4c27ZurdH9QpfPRi7uDRnZdh0kTp9p5jmpjZM8QYMs5K9rXfPjCwRaztttdRnZzGsh81QWytua61S52hta5jn9e237k5Sd\x252B1SnyxfSt14vG2v57WSQ4\x252FycO6bsRIO2IPLCVeksUfS19XPLvrEZewZo71RzzRou0mdg49oLEQSAi4hChFgTkiABEEgMNCAz6QxPWyVsVzZ1CGIYBdhl0Q5xgz5jITFhO2vNh5rVdbq475nMUOGPeX53t2\x252FvOXO4h06M7keACdbjUrZNLu7yfJ\x252BW24MdGN0TjZifHgPxP5iYUklMKFEVCIGCiXmNIq5H0JFZYmigLtznEVRyDCUAAF1OSTg0lhGbswT6lIhk7IM4gr8YOXdKMzm3f8vkP0C\x26RelayState\x3DJh0cA5MTQEEz86a7mvaw\x2DBAZ37kVcXKY';
  var username = '';
  var rememberMe = true;
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://ok3static.oktacdn.com/fs/bco/1/fs012f1apkhr1XAna1e8',
      logoText: 'Upwork logo',
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://ok3static.oktacdn.com/fs/bco/7/fs01e5qly8wUFWeam1d8')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://ok3static.oktacdn.com/fs/bco/7/fs01e5qly8wUFWeam1d8', sizingMethod='scale')");
  });
</script>
