...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;oauth2&#x2f;v1&#x2f;authorize&#x2f;redirect&#x3f;okta_key&#x3d;rfYkGZ_9AtfgePky0_BhnL_AynMI1E0xP5RJZwsjOK4"/>
</form>
...
(function(){
  ...
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Foauth2\x2Fv1\x2Fauthorize\x2Fredirect\x3Fokta_key\x3DrfYkGZ_9AtfgePky0_BhnL_AynMI1E0xP5RJZwsjOK4';
  var username = '';
  var rememberMe = true;
