...
</div><div class="columns row"><div class="column main col-xs-12"><input name="form_key" type="hidden" value="i09x9km8fmCoI4f2" /><div id="authenticationPopup" data-bind="scope:'authenticationPopup'" style="display: none;">
    <script>
            ...
            <div class="spectrum-Custom-Body" aria-labelledby="block-customer-login-heading">
                <div class="spectrum-Custom-Body__content">
                    ...
                    <form class="form form-login mt-40"
                        ...
                        <input name="form_key" type="hidden" value="i09x9km8fmCoI4f2" />                        <fieldset class="fieldset fieldset-inline login" data-hasrequired="">
...
</div>    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"95a6a0aaac","applicationID":"589020890","transactionName":"YFdQYkJTWUACAEBbClkdc1VEW1hdTABBQRFYX1dEH1NUUAwWWkZKW11VX14=","queueTime":0,"applicationTime":465,"atts":"TBBTFApJSk4=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
```