			...
			<div class="container">
				...
				<form class="header_box" onsubmit="return inputedAddress();">
					<div class="header_city tooltip">
						<a href="#" class="tooltip_title js-toggle-tooltip" id="current-city">Астрахань</a>
		...
		<div class="container">
			<div class="row main-footer_top">
				<div class="col s-8">
					...
					<p>© 2013-2021 ZakaZaka, Астрахань. <strong>Ресторанов много, сайт – один.</strong></p>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"7e9a0603ad","applicationID":"56027851","transactionName":"YgFSNhdQCkEFUhVaDVtLZRAMHg1cAFQZHRJdFA==","queueTime":0,"applicationTime":78,"atts":"TkZRQF9KGU8=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
```