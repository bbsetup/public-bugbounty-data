...
<head>
  ...
  <meta name="author" content="Meraki, Inc.">
    <link rel="Shortcut Icon" href="/favicon.ico?1611136583" type="image/x-icon" />
  <script src="/javascripts/jquery-1.8.3.min.js?1611136573" type="text/javascript"></script>
  <script src="/javascripts/jquery.cookie.min.js?1611136573" type="text/javascript"></script>
  <script src="/javascripts/modernizr.min.js?1611136572" type="text/javascript"></script>
  <link href="/stylesheets/normalize.min.css?1611136582" media="all" rel="stylesheet" type="text/css" />
  <link href="/stylesheets/minified/dashboard_login.css?1611136573" media="all" rel="stylesheet" type="text/css" />
  <link href="/stylesheets/minified/login_promo.css?1611136573" media="all" rel="stylesheet" type="text/css" />
...
<div id="container">
  ...
  <header id="masthead">
    <div id="masthead-content">
      <a href="https://meraki.cisco.com/"><img alt="Cisco Meraki" src="/images/cisco-meraki.png?1611136595" width="165" /></a>
    </div>
  </header>
...
<div id="cookie_failure_container">
  <div class="notice_explanation_container">
    <div class="notice_explanation bad">Your browser must have cookies enabled to use Dashboard.</div>
          ...
          <form accept-charset="UTF-8" action="/login/email_lookup" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="he8VNATr0ZhuuD9X3ogYaTPP5umgbEGk3M+slSDOgrQ=" /></div> 
            ...
            <div id="formarea-buttons">
              ...
              <input type="hidden" name="goto" value="manage" /><input type="hidden" name="go" value="/" /><input type="hidden" name="sh" value="2" />
            </div>
          </form>
          ...
          <div id="formarea-bottom" class="clearfix">
            <ul>
              ...
              <li><a href="https://n2.test.ikarem.io/login/signup">Create an account</a></li>
            </ul>
          </div>
