...
<section class="section section--tight section-block--light grid--bleed section-block--border-top js-track-inline-signup">
  <div class="grid">
    ...
    <div class="grid__item grid__item--tablet-up-two-thirds grid__item--desktop-up-half grid__item--tablet-up-align-center ">
      <form class="js-signup-inline marketing-form--inline" novalidate="novalidate" action="https://accounts.shopify.com/store-signup/setup" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Blga11V00hMcVunpB3SlKLdSACfnUn105Iw9q8Gi1yf9s3hx4um9ByFfLS+EBxpV7PSSqsDn1VtqYU1xQcZERg==" /><div class="marketing-input-wrapper marketing-input-button-pair"><div class="marketing-input-button-pair__field-wrapper"><label class="marketing-label marketing-label--in-field marketing-label--floating marketing-input-button-pair__label" for="SignupEmail-235a">Email address</label><input placeholder="Enter your email address" id="SignupEmail-235a" class="marketing-input-button-pair__input marketing-input marketing-input--floating" type="email" name="signup[email]" /><button class="marketing-button marketing-form__button marketing-input-button-pair__button" name="button" data-ga-event="Email capture signup" data-ga-action="CTA button click" aria-haspopup="dialog" type="submit">Start free trial</button></div><span class="marketing-form__messages"></span></div></form>
</div></div></section>
...
<div class="grid__item grid__item--mobile-up-half grid__item--tablet-up-1">
  ...
  <div class="grid">
    ...
    <div class="grid__item grid__item--tablet-up-4 footer-bottom__links text-center--mobile text-right--tablet-up">
      ...
      <div class="footer-country-select"><div class="popover-wrapper js-popover footer-country-select__popover" id="locale-selector" toggle_only_on_click="true" data-position="top" data-align="right"><button type="button" class="popover__trigger footer-country-select__trigger" data-ga-event="Footer" data-ga-label="CountrySelector"><svg class="icon footer-country-select__globe" aria-hidden="true" focusable="false"> <use xlink:href="#globe" /> </svg><span class="footer-country-select__text">English</span><span class="visuallyhidden">Change your country or region.</span><svg class="icon footer-country-select__arrow" aria-hidden="true" focusable="false"> <use xlink:href="#modules-nav-arrow-down" /> </svg></button><div class="popover"><ul class="popover__content footer-country-select__content"><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=da"><button class="footer-country-select__country-button body-link" type="submit">Dansk</button><input type="hidden" name="authenticity_token" value="UVsNC19QKWQSDkjNfZKwwMyhUMtXs/HS38wctHXVe5CqsG+t6M1GcC8HjAv+4Q+9lwfCRnAGWf1RIWxu9bHo8Q==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=de"><button class="footer-country-select__country-button body-link" type="submit">Deutsch</button><input type="hidden" name="authenticity_token" value="FnB3POAjewOoqFwbFF7YIMx5EnpnkuiQO+FWYOO0fwvtmxWaV74UF5WhmN2XLWddl9+A90AnQL+1DCa6Y9Dsag==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=en"><button class="footer-country-select__country-button body-link" type="submit">English</button><input type="hidden" name="authenticity_token" value="PysW0a1ToUcEdQhkwoDOD+PW73dHQCmWtDepJI2DPMHEwHR3Gs7OUzl8zKJB83FyuHB9+mD1gbk62tn+DeevoA==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=es"><button class="footer-country-select__country-button body-link" type="submit">Español</button><input type="hidden" name="authenticity_token" value="ebYn/WcUAo/chnZ3aAliNFPPm/q1GVQQtb3vXY4SQp2CXUVb0Iltm+GPsrHret1JCGkJd5Ks/D87UJ+HDnbR/A==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=fr"><button class="footer-country-select__country-button body-link" type="submit">Français</button><input type="hidden" name="authenticity_token" value="vBTQRdD6GvyDVj5aSv7a5LDsVCBlxl5jNs18jZey9RZH/7LjZ2d16L5f+pzJjWWZ60rGrUJz9ky4IAxXF9Zmdw==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=it"><button class="footer-country-select__country-button body-link" type="submit">Italiano</button><input type="hidden" name="authenticity_token" value="LSTOq+gq8m/Vwa947ejFv+spzqXSRJHdIelHTrGQWILWz6wNX7ede+jIa75um3rCsI9cKPXxOfKvBDeUMfTL4w==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=nl"><button class="footer-country-select__country-button body-link" type="submit">Nederlands</button><input type="hidden" name="authenticity_token" value="WTmuBWN8NFaNNrha7yjPVuqCjK/nBn8rFBXyCbDN8bei0syj1OFbQrA/fJxsW3ArsSQeIsCz1wSa+ILTMKli1g==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=nb"><button class="footer-country-select__country-button body-link" type="submit">Norsk (bokmål)</button><input type="hidden" name="authenticity_token" value="+PwdI1XYKr7cC53XeZPjdPpzKqU4wqcgvW19s2ng+M0DF3+F4kVFquECWRH64FwJodW4KB93Dw8zgA1p6YRrrA==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=pl"><button class="footer-country-select__country-button body-link" type="submit">Polski</button><input type="hidden" name="authenticity_token" value="rWrXgR72+PLTAicJg+6CvN4BwahyQYgBjHyOKTeviIFWgbUnqWuX5u4L488AnT3BhadTJVX0IC4Ckf7zt8sb4A==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=pt-BR"><button class="footer-country-select__country-button body-link" type="submit">Português (brasil)</button><input type="hidden" name="authenticity_token" value="r8zsop18HVi3DigtZKqqwQdDS/2jicaxbnv4vuxagU5UJ44EKuFyTIoH7Ovn2RW8XOXZcIQ8bp7glohkbD4SLw==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=pt-PT"><button class="footer-country-select__country-button body-link" type="submit">Português (portugal)</button><input type="hidden" name="authenticity_token" value="p2pMi6WbEx2jRnbo1F0lW4fIgy4OQ8KLu0v9eQct021cgS4tEgZ8CZ5Psi5XLpom3G4Royn2aqQ1po2jh0lADA==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=fi"><button class="footer-country-select__country-button body-link" type="submit">Suomi</button><input type="hidden" name="authenticity_token" value="Z1HZVnByOtb1xwZzQ2CKi3tJkXX7pBr3BcajZJ+pxTKcurvwx+9VwsjOwrXAEzX2IO8D+NwRstiLK9O+H81WUw==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=sv"><button class="footer-country-select__country-button body-link" type="submit">Svenska</button><input type="hidden" name="authenticity_token" value="Y/wAaYnUUxBtUlBk6VvrdizZrBSV2CJ0U4tK1TtcH52YF2LPPkk8BFBblKJqKFQLd38+mbJtilvdZjoPuziM/A==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=tr"><button class="footer-country-select__country-button body-link" type="submit">Türkçe</button><input type="hidden" name="authenticity_token" value="wEiFruP6R46POZbWlZSDmwwXdIcsPPVgTH2SL5qLNoQ7o+cIVGcomrIwUhAW5zzmV7HmCguJXU/CkOL1Gu+l5Q==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=cs"><button class="footer-country-select__country-button body-link" type="submit">Čeština</button><input type="hidden" name="authenticity_token" value="U6pojIYaZln3z5KORXslcqhBJLOBEOmkovIY+wJeB/CoQQoqMYcJTcrGVkjGCJoP8+e2PqalQYssH2ghgjqUkQ==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=th"><button class="footer-country-select__country-button body-link" type="submit">ภาษาไทย</button><input type="hidden" name="authenticity_token" value="yvjPz0QeW88bvruW0BuWH+clMObXngqXudF69HmwCJQxE61p84M02ya3f1BTaClivIOia/Arorg3PAou+dSb9Q==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=ja"><button class="footer-country-select__country-button body-link" type="submit">日本語</button><input type="hidden" name="authenticity_token" value="GXr58TDlA90XFw98jVrg5DFGpDAlEZFqXD6yBzjvRKTikZtXh3hsySoey7oOKV+ZauA2vQKkOUXS08LduIvXxQ==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=zh-CN"><button class="footer-country-select__country-button body-link" type="submit">简体中文</button><input type="hidden" name="authenticity_token" value="MfSFI1t+WofKke4Vhj2WreKNaqwaBMLpBGe3bqHdLaPKH+eF7OM1k/eYKtMFTinQuSv4IT2xasaKise0Ibm+wg==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=zh-TW"><button class="footer-country-select__country-button body-link" type="submit">繁體中文</button><input type="hidden" name="authenticity_token" value="Jbp/hZNWPCWDlkez3vPDdZHj3xbnEwckhV3eCAtlKmTeUR0jJMtTMb6fg3VdgHwIykVNm8CmrwsLsK7SiwG5BQ==" /></form></li><li class="footer-country-select__country"><form class="marketing-button-wrapper" method="post" action="https://apps.shopify.com/set_locale?locale=ko"><button class="footer-country-select__country-button body-link" type="submit">한국어</button><input type="hidden" name="authenticity_token" value="buo21+4VQLUy/eFr7R5uliyaV9sOvqDgQ4Bs1ltXI1+VAVRxWYgvoQ/0Ja1ubdHrdzzFVikLCM/NbRwM2zOwPg==" /></form></li></ul></div></div></div>
...
<script src="https://cdn.shopify.com/shopifycloud/shopify_app_store/bundles/baseline/application-00e232c3a71fed9bfc24708882629cf4f9a4ce87df386dffb4a29eada9d5ebb4.js"></script>
  ...
  <div class="ui-modal__body" role="document">
    ...
    <form id="AuthLoginForm" action="/login/initiate_shopify_auth" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="rUQbbGrtCTgsAw7Ua35ZcHkBQsyMK12rO6Jn5PKX4Z5Wr3nK3XBmLBEKyhLoDeYNIqfQQaue9YS1Txc+cvNy/w==" />
  ...
  <div class="ui-modal__footer">
      <div class="ui-modal__tertiary-action">
        <form class="button_to" method="post" action="https://apps.shopify.com/partner/login?return_path=%2F"><input class="button-as-link ui-modal__tertiary-action" type="submit" value="Developer login" /><input type="hidden" name="authenticity_token" value="JK5MhbAc32kbmFVvN53O3wyce//q6rV36+O3nC5s+HLfRS4jB4GwfSaRkam07nGiVzrpcs1fHVhlDsdGrghrEw==" /></form>
</div>
