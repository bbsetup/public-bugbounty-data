...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;oauth2&#x2f;v1&#x2f;authorize&#x2f;redirect&#x3f;okta_key&#x3d;4XHQOreTXCl9OzZiklGp9fo7qXvm-g1flyqz7IQFpPg"/>
</form>
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fshopify.okta.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Foauth2\x2Fv1\x2Fauthorize\x2Fredirect\x3Fokta_key\x3D4XHQOreTXCl9OzZiklGp9fo7qXvm\x2Dg1flyqz7IQFpPg';
  var username = '';
  ...
  var signinLabel = 'Sign\x20in\x20to\x20Okta';
  var forgotpasswordLabel = 'Forgot\x20your\x20password\x3F';
  var unlockaccountLabel = 'Unlock\x20account\x3F';
  var helpLabel = 'Okta\x20Help\x20Page';
  ...
  var customLinks = [];
    ...
    customLinks.push({
      text: 'Can\x27t\x20login\x20or\x20lost\x20your\x20phone\x3F',
      href: 'https\x3A\x2F\x2Fshopify.box.com\x2Fs\x2F7zro36hzpm2c08m94rqolxws64var8b7'
    });
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://ok2static.oktacdn.com/fs/bco/1/fs0p1ykqxrkTjqrF40x7',
      logoText: 'Shopify logo',
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://ok2static.oktacdn.com/fs/bco/7/fs0nh8tzw2GBI8ATs0x7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://ok2static.oktacdn.com/fs/bco/7/fs0nh8tzw2GBI8ATs0x7', sizingMethod='scale')");
  });
</script>
