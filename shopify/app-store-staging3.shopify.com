...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;oauth2&#x2f;v1&#x2f;authorize&#x2f;redirect&#x3f;okta_key&#x3d;U9Zb2US18zrr5p3xv4P09h9g9H3C62_ufWP_eOQtkgM"/>
</form>
...
(function(){
  ...
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Foauth2\x2Fv1\x2Fauthorize\x2Fredirect\x3Fokta_key\x3DU9Zb2US18zrr5p3xv4P09h9g9H3C62_ufWP_eOQtkgM';
  var username = '';
