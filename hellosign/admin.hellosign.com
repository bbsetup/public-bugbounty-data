...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;oauth2&#x2f;v1&#x2f;authorize&#x2f;redirect&#x3f;okta_key&#x3d;SMt6YGdXQ1BIBqEVUtfYbiO9_PVsS3W5qLTuRXlvoRI"/>
</form>
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fhellosign.okta.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Foauth2\x2Fv1\x2Fauthorize\x2Fredirect\x3Fokta_key\x3DSMt6YGdXQ1BIBqEVUtfYbiO9_PVsS3W5qLTuRXlvoRI';
  var username = '';
  var rememberMe = true;
  ...
  var usernameInlineLabel = '\x3Cusername\x3E\x40hellosign.com';
  var passwordLabel = 'Password';
  var passwordInlineLabel = 'Unsure\x3F\x20Check\x201Password\x20or\x20Lastpass';
  var signinLabel = 'Employee\x20Login';
  var forgotpasswordLabel = 'Forgot\x20password\x3F';
  var unlockaccountLabel = 'Unlock\x20account\x3F';
  var helpLabel = 'Help';
  var orgSupportPhoneNumber = '\x28407\x29\x20242\x202537';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://ok2static.oktacdn.com/fs/bco/1/fs0n2jb1flXzil3SG0x7',
      logoText: 'HelloSign logo',
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://ok2static.oktacdn.com/fs/bco/7/fs0cqymrceA06owTG0x7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://ok2static.oktacdn.com/fs/bco/7/fs0cqymrceA06owTG0x7', sizingMethod='scale')");
  });
</script>
