...
<head>
    ...
    <title>Boston Consulting Group, Inc. - Preview - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fbcg.oktapreview.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0jowkqjuYbBc7wD0h7',
      logoText: 'Boston\x20Consulting\x20Group,\x20Inc.\x20\x2D\x20Preview logo',
