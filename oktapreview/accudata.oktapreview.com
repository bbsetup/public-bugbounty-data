...
<head>
    ...
    <title>Accudata Systems-dev-144727 - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Faccudata.oktapreview.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      logoText: 'Accudata\x20Systems\x2Ddev\x2D144727 logo',
