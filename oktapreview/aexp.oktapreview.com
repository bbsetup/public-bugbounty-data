...
<head>
    ...
    <title>American Express - Preview - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Faexp.oktapreview.com';
  ...
  var unlockaccountLabel = 'Unlock\x20account';
  var helpLabel = 'Help';
  var orgSupportPhoneNumber = '6023002898';
  var hideSignOutForMFA = false;
  var hideBackToSignInForReset = false;
  var footerHelpTitle = 'Need\x20help\x20sign\x20in\x20\x3F';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0g3ewypuw8MaDf90h7',
      logoText: 'American\x20Express\x20\x2D\x20Preview logo',
      ...
      helpLinks: {
        help: '',
        forgotPassword: 'https\x3A\x2F\x2Fdummy.com',
        unlock: '',
        custom: customLinks
      }
    }
