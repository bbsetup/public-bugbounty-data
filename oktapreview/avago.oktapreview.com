...
<head>
    ...
    <title>Broadcom Inc. - EXT-DEV - Sign In</title>
        <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="robots" content="none" />
    <script src="https://sso-stage.broadcom.com/assets/js/sdk/okta-signin-widget/5.2.1/js/okta-sign-in.min.js" type="text/javascript"></script>
    <link href="https://sso-stage.broadcom.com/assets/js/sdk/okta-signin-widget/5.2.1/css/okta-sign-in.min.css" type="text/css" rel="stylesheet"/>
    <link href="https://avago.oktapreview.com/assets/loginpage/css/loginpage-theme.7138a0eb969c6a25c2d39004ad54df8a.css" type="text/css" rel="stylesheet"/><script>
        var okta = {
            locale: 'en',
            deployEnv: 'PREVIEW'
        };
    </script>
    <script>window.okta || (window.okta = {}); okta.cdnUrlHostname = ""; okta.cdnPerformCheck = true; okta.cdnPerformCheckHostname = "//op1static.oktacdn.com";</script><script>if (window.module) module = window.module;</script>
...
<script type="text/javascript">function runLoginPage (fn) {var mainScript = document.createElement('script');mainScript.src = 'https://avago.oktapreview.com/assets/js/mvc/loginpage/initLoginPage.pack.bb0aa11a63d230e8b135b92ba459ee7e.js';mainScript.crossOrigin = 'anonymous';mainScript.integrity = 'sha384-pigRdMXEy7yI9Qz6y9AVg1Gevie0LwAPvv7OUKRG7ZKz9B5H/Zgdl1Bm5onnwxa0';document.getElementsByTagName('head')[0].appendChild(mainScript);fn && mainScript.addEventListener('load', function () { setTimeout(fn, 1) });}</script><script type="text/javascript">
(function(){

  var baseUrl = 'https\x3A\x2F\x2Favago.oktapreview.com';
  ...
  var signinLabel = 'Broadcom\x20Inc.\x20Customer\x20Sign\x2DIn';
  var forgotpasswordLabel = 'Forgot\x20password\x3F';
  var unlockaccountLabel = 'Unlock\x20account\x3F';
  var helpLabel = 'Account\x20Registration\x20Self\x2DService\x20Tool';
  ...
  var signOutUrl = 'https\x3A\x2F\x2Fwww.broadcom.com\x2F';
  ...
  var customLinks = [];
    ...
    customLinks.push({
      text: 'ChatBot\x20Login\x20Assistance',
      href: 'https\x3A\x2F\x2Fportal.broadcom.com\x2Fweb\x2Fcustomers\x2Fchatbot'
    });
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://avago.oktapreview.com/fs/bco/1/fs0ktiu8r4SjrWKwA0h7',
      logoText: 'Broadcom\x20Inc.\x20\x2D\x20EXT\x2DDEV logo',
      ...
      assets: {
        baseUrl: "https\x3A\x2F\x2Fsso\x2Dstage.broadcom.com\x2Fassets\x2Fjs\x2Fsdk\x2Fokta\x2Dsignin\x2Dwidget\x2F5.2.1"
      },
      ...
      helpLinks: {
        help: 'https\x3A\x2F\x2Fportal.broadcom.com\x2Fweb\x2Fguest\x2Fself\x2Dsupport\x2Dportal',
        forgotPassword: 'https\x3A\x2F\x2Fportal.broadcom.com\x2Fweb\x2Fguest\x2Fforgotpassword',
        unlock: '',
        custom: customLinks
      }
    }
