...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Favalara.oktapreview.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '00sPes8IHPjm7mOcjmwabjE1t0lMiw63zEMQifG9oL';
  ...
  var signinLabel = '\x2A\x2A\x20Avalara\x20Okta\x20Sandbox\x20\x2A\x2A';
  var forgotpasswordLabel = 'Forgot\x20password\x3F';
  var unlockaccountLabel = 'Unlock\x20account\x3F';
  var helpLabel = 'General\x20Okta\x20Help';
  ...
  var customLinks = [];
    ...
    customLinks.push({
      text: 'Still\x20need\x20help\x3F\x20Click\x20here\x20to\x20submit\x20a\x20request\x20to\x20the\x20Avalara\x20Service\x20Desk.',
      href: 'https\x3A\x2F\x2Favalara.atlassian.net\x2Fsecure\x2FCreateIssueDetails\x2521init.jspa\x3Fpid\x3D12700\x26issuetype\x3D25'
    });
  ...
  var consentFunc;
    ...
    consentFunc = {
      cancel: function() {
        window.location.href='https://avalara.oktapreview.com/login/token/redirect?stateToken=00sPes8IHPjm7mOcjmwabjE1t0lMiw63zEMQifG9oL'
      }
    };
  ...
  var loginPageConfig = {
    ...
    enrollingFactor: '',
    stateTokenExpiresAt: 'Wed\x20Jan\x2027\x2012\x3A07\x3A36\x20UTC\x202021',
    signIn: {
      el: '#signin-container',
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs08sqvjyfq8dRHvU0h7',
      logoText: 'Avalara logo',
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://op1static.oktacdn.com/fs/bco/7/fs08wepmurMslHDd10h7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://op1static.oktacdn.com/fs/bco/7/fs08wepmurMslHDd10h7', sizingMethod='scale')");
  });
</script>
