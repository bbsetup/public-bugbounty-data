...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Famgendev.oktapreview.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs057ieysnekz8sdx0h7',
      logoText: 'Amgen\x20\x28Dev\x29 logo',
