...
<head>
    ...
    <title>Amway Sandbox - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Famway.oktapreview.com';
  ...
  var usernameLabel = 'Native\x20ID';
  ...
  var helpLabel = 'Help';
  var orgSupportPhoneNumber = '616\x2D787\x2D8500';
  ...
  var signOutUrl = 'https\x3A\x2F\x2Famway.oktapreview.com\x2Flogin\x2Fdefault';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs02y1la1iHLPMWXYECB',
      logoText: 'Amway\x20Sandbox logo',
