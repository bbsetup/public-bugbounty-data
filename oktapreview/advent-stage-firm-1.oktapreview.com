...
<head>
    ...
    <title>Advent Software, Inc. - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fadvent\x2Dstage\x2Dfirm\x2D1.oktapreview.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      logoText: 'Advent\x20Software,\x20Inc. logo',
