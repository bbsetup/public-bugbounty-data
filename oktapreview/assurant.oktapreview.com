...
<head>
    ...
    <title>Assurant, Inc - Preview - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fassurant.oktapreview.com';
  ...
  var usernameInlineLabel = 'Assurant\x20LAN\x20ID';
  ...
  var recoveryFlowPlaceholder = 'Username';
  var signOutUrl = '';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0vkljb3fwEyoDI30h7',
      logoText: 'Assurant,\x20Inc\x20\x2D\x20Preview logo',
      ...
      helpLinks: {
        help: 'https\x3A\x2F\x2Fid\x2Dmodel.assurant.com\x2Fsign\x2Din\x2Dhelp\x2Dinternal\x2Dmain\x2Dpage',
        forgotPassword: '',
        unlock: '',
        custom: customLinks
      }
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://op1static.oktacdn.com/fs/bco/7/fs0vps6gjaBErNvga0h7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://op1static.oktacdn.com/fs/bco/7/fs0vps6gjaBErNvga0h7', sizingMethod='scale')");
  });
</script>
