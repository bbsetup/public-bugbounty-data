...
<head>
    ...
    <title>Athenahealth Inc. - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fathena.oktapreview.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '006KyPd_TngJlIGFfWNKW_RdjEa4R6iuk\x2DLYvOVw\x2DL';
  ...
  var forgotpasswordLabel = '.';
  var unlockaccountLabel = '.';
  var helpLabel = '.';
  ...
  var consentFunc;
    ...
    consentFunc = {
      cancel: function() {
        window.location.href='https://athena.oktapreview.com/login/token/redirect?stateToken=006KyPd_TngJlIGFfWNKW_RdjEa4R6iuk-LYvOVw-L'
      }
    };
  ...
  var loginPageConfig = {
    ...
    enrollingFactor: '',
    stateTokenExpiresAt: 'Wed\x20Jan\x2027\x2006\x3A08\x3A07\x20UTC\x202021',
    signIn: {
      el: '#signin-container',
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0d8osnpvw4w3oJz0h7',
      logoText: 'Athenahealth\x20Inc. logo',
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://op1static.oktacdn.com/fs/bco/7/fs0d8plk74IX5uUBT0h7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://op1static.oktacdn.com/fs/bco/7/fs0d8plk74IX5uUBT0h7', sizingMethod='scale')");
  });
</script>
