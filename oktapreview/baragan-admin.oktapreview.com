...
<head>
    ...
    <title>Baragan Inc. - Sign In</title>
        <meta charset="UTF-8">
...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;home&#x2f;admin-entry"/>
</form>
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fbaragan.oktapreview.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Fhome\x2Fadmin\x2Dentry';
  var username = '';
  var rememberMe = true;
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0ptwf0c3exbeOH00h7',
      logoText: 'Baragan\x20Inc. logo',
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://op1static.oktacdn.com/fs/bco/7/fs0pxfo11uP0D3Eq00h7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://op1static.oktacdn.com/fs/bco/7/fs0pxfo11uP0D3Eq00h7', sizingMethod='scale')");
  });
</script>
