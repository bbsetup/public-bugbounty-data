...
<head>
    ...
    <title>Amgen (test) - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Famgentest.oktapreview.com';
  ...
  var signOutUrl = 'https\x3A\x2F\x2Famgentest.oktapreview.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      logoText: 'Amgen\x20\x28test\x29 logo',
