...
<head>
    ...
    <title> American Society of Clinical Oncology, Inc. - Preview - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fasco.oktapreview.com';
  ...
  var recoveryFlowPlaceholder = 'Email';
  var signOutUrl = '';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0fr75diqSiawhv10h7',
      logoText: '\x20American\x20Society\x20of\x20Clinical\x20Oncology,\x20Inc.\x20\x2D\x20Preview logo',
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://op1static.oktacdn.com/fs/bco/7/fs0g31zj5ptrvVJwl0h7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://op1static.oktacdn.com/fs/bco/7/fs0g31zj5ptrvVJwl0h7', sizingMethod='scale')");
  });
</script>
