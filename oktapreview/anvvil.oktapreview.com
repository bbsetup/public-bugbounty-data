...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fanvvil.oktapreview.com';
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://op1static.oktacdn.com/fs/bco/7/fs0qz1ra3exOwMm2H0h7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://op1static.oktacdn.com/fs/bco/7/fs0qz1ra3exOwMm2H0h7', sizingMethod='scale')");
  });
</script>
