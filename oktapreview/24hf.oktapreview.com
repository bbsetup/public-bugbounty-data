...
<head>
    ...
    <title>24 Hour Fitness - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2F24hf.oktapreview.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0jq7jtk832HvF4R0h7',
      logoText: '24\x20Hour\x20Fitness logo',
      ...
      helpLinks: {
        help: 'https\x3A\x2F\x2Fmy24.24hourfit.com',
        forgotPassword: 'https\x3A\x2F\x2F24hf.oktapreview.com\x2Fsignin\x2Fforgot\x2Dpassword',
        unlock: '',
        custom: customLinks
      }
    }
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://op1static.oktacdn.com/fs/bco/7/fs0jqb3naviqIOC1e0h7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://op1static.oktacdn.com/fs/bco/7/fs0jqb3naviqIOC1e0h7', sizingMethod='scale')");
  });
</script>
