...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fatkoice.oktapreview.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '00Dae3ylK3qoz5CqPqdr2O\x2DuhXD\x2DK9IzoYupB3RJ_B';
  ...
  var signOutUrl = 'https\x3A\x2F\x2Fatkoice.oktapreview.com\x2Fslo';
  ...
  var consentFunc;
    ...
    consentFunc = {
      cancel: function() {
        window.location.href='https://atkoice.oktapreview.com/login/token/redirect?stateToken=00Dae3ylK3qoz5CqPqdr2O-uhXD-K9IzoYupB3RJ_B'
      }
    };
  ...
  var loginPageConfig = {
    ...
    enrollingFactor: '',
    stateTokenExpiresAt: 'Wed\x20Jan\x2027\x2006\x3A09\x3A41\x20UTC\x202021',
    signIn: {
      el: '#signin-container',
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0nbe1k6kGbQUgEQ0h7',
      logoText: 'AtkoIce logo',
