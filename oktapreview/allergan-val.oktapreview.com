...
<head>
    ...
    <title>allergan-val - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fallergan\x2Dval.oktapreview.com';
  ...
  var helpLabel = 'Help\x3F';
  var orgSupportPhoneNumber = '714\x2D246\x2D5561';
  ...
  var customLinks = [];
    ...
    customLinks.push({
      text: 'AGN\x20Disclaimer',
      href: 'http\x3A\x2F\x2Fbeta\x2Dagn\x2Dallergan.cs9.force.com\x2FLoginMessage'
    });
