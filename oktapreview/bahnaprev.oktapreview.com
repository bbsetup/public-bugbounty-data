...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fbahnaprev.oktapreview.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0kh0pc0gA22ZUYa0h7',
      logoText: 'Bahna\x20Inc logo',
