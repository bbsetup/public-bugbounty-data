...
<head>
    ...
    <title>Kim Technologies-dev-531313 - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fask.oktapreview.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs0dczotisnXszZCA0h7',
      logoText: 'Kim\x20Technologies\x2Ddev\x2D531313 logo',
