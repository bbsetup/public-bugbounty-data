...
<head>
    ...
    <title>Avery Dennison - Preview - Sign In</title>
        <meta charset="UTF-8">
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fadtest.oktapreview.com';
  ...
  var usernameInlineLabel = 'Example\x3A\x20name\x40averydennison.com';
  var passwordLabel = 'Password';
  var passwordInlineLabel = '';
  var signinLabel = 'Sign\x20In';
  var forgotpasswordLabel = 'Forgot\x20Password';
  var unlockaccountLabel = 'Unlock\x20account\x3F';
  var helpLabel = 'Contact\x20the\x20IT\x20Service\x20Desk';
  ...
  var signOutUrl = 'http\x3A\x2F\x2Fwww.averydennison.com';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://op1static.oktacdn.com/fs/bco/1/fs02ryq4cgZECJKPSPWW',
      logoText: 'Avery\x20Dennison\x20\x2D\x20Preview logo',
      ...
      helpLinks: {
        help: 'https\x3A\x2F\x2Fsites.google.com\x2Fa\x2Faverydennison.com\x2Fcontact\x2Dit\x2Dservice\x2Ddesk\x2F',
        forgotPassword: '',
        unlock: '',
        custom: customLinks
      }
