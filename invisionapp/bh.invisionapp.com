			...
			<div class="main-panel__table">
				<div class="main-panel__table-cell">
					...
					<div class="main-panel__content">
								...
								<img src="/logos/BD0371EA-C0F3-193C-8189BBE6398083B6" class="main-panel__badge" />
						

						<h1 class="main-panel__heading">
							Sign in to Amazon - AWS Beehive.
						</h1>
						...
						<form
							...
							<input type="hidden" name="formToken" value="i--olwqp4XPH_dvuaO7lfQv5zzsasDbY-4iNi823mWA" />
							<input type="hidden" name="formTokenRendered" value="Thu, 11 Feb 2021 09:09:08 GMT" />
