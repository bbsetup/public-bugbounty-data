				...
				<div class="main-panel__table-cell">
					...
					<div class="main-panel__content">
						...
						<form
							...
							<input type="hidden" name="formToken" value="wCT5yEKDTzRIovRj_2miZ3a4Kkakxp9i1xab_OEobhU" />
							<input type="hidden" name="formTokenRendered" value="Wed, 27 Jan 2021 05:09:46 GMT" />
