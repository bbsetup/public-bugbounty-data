...
<script type="text/javascript" src="/assets/apps/common/utilities/invision-scripts.js?v=eef9b248"></script>
	...
	<script type="text/javascript" src="/assets/apps/common/utilities/invision-scripts.js?v=eef9b248"></script>
			...
			<script type="text/javascript">
				window.invisionUtils.embedStorageConsentScript("eef9b248");
			</script>
	...
	<div class="panel-wrapper">
			...
			<a href="//www.invisionapp.com" class="invision-logo invision-logo--single">InVision</a>
			...
			<div class="main-panel__table">
				<div class="main-panel__table-cell">
					...
					<div class="main-panel__content">
								...
								<img src="/logos/4EBAC182-0A5A-1EE2-642395BA690CE0FE" class="main-panel__badge" />
						...
						<h1 class="main-panel__heading">
							...
							<div class="saml-button text--center">
								<div class="text--center">
									<a href="/sso/sp_login?redir=" class="form__button form__button--pink-accessible ssoButton">Sign in using SSO</a>
								</div>

								<a class="sso-alternate" href="#">Or sign in via Email</a>
							</div>
						...
						<form
							class="main-panel__form Bizible-Exclude hidden"
							action="/d/login/authenticate" method="post" novalidate>

							

							<input type="hidden" name="redir" value="" />
							<input type="hidden" name="redirHash" value="" id="redirHash" />
							<input type="hidden" name="formToken" value="gMF-hdT7bv-qnnUeP_kK3nRZsHvS34VYIeeQbR1-tKQ" />
							<input type="hidden" name="formTokenRendered" value="Wed, 27 Jan 2021 11:07:32 GMT" />
							...
							<div class="form__group">
								...
								<input id="emailAddress" type="email" name="email" class="form__input" placeholder="julie@widgetco.com" value="" />
							</div>
							...
							<div class="text--center">
								<button class="form__button form__button--pink-accessible">Sign in</button>
							</div>
						</form>

						
							<div class="saml-button hidden">
								<a class="sso-alternate" href="#">Or sign in via SSO</a>
							</div>
						...
						<div class="main-panel__footer">
							If you are not an existing member of this account, please contact your administrator for an invite.
						</div>
	...
	<script>
		...
		(function() {
			...
			$(".sso-alternate").on("click", function() {
				$(".saml-button, .main-panel__form").toggleClass("hidden");
			});
			...
			if( window.location.hash ){
				...
				$(".ssoButton").attr('href', $(".ssoButton").attr('href') + "&redirHash=" + encodeURIComponent(window.location.hash));
			}

			// Handle SSO Knock
			var ssoKnockModal = $(".sso-knock-modal");
			var sendKnockEvent = function sendKnockEvent(provider) {
				window.analytics.track("Login.SSOKnock", {
					SSOType: provider
				});

				$.post("/d/login/sendTrySSOEmail");
			};

			$(".sso-knocking__option-item").on('click', function() {
				var provider = $(this).attr("data-provider");

				sendKnockEvent(provider);

				ssoKnockModal.toggleClass("hidden");
			});

			// Close the modal when background or button is clicked
			$(".sso-knock-modal, .sso-knock-modal .back").on('click', function() {
				ssoKnockModal.toggleClass("hidden");
			});

			// Don't close the modal when content is clicked
			$(".sso-knock-modal .content").on("click", function(e) {
				e.stopPropagation();
			});
