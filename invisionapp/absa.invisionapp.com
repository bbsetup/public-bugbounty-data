				...
				<div class="main-panel__table-cell">
					...
					<div class="main-panel__content">
						...
						<form
							...
							<input type="hidden" name="formToken" value="mGsdwmebSvLqpH8QSJcFKRqiw9OK_KXYE_wcEFDutj4" />
							<input type="hidden" name="formTokenRendered" value="Fri, 22 Jan 2021 20:56:49 GMT" />
