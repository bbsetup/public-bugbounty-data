				...
				<div class="main-panel__table-cell">
					...
					<div class="main-panel__content">
						...
						<form
							...
							<input type="hidden" name="formToken" value="GcYkOy4jLpVe3fN7VUjXjXPxlG3GmhmfnP-YnFLpQIU" />
							<input type="hidden" name="formTokenRendered" value="Sat, 23 Jan 2021 02:22:02 GMT" />
