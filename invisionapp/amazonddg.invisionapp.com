				...
				<div class="main-panel__table-cell">
					...
					<div class="main-panel__content">
						...
						<form
							...
							<input type="hidden" name="formToken" value="AqugovuY8Is_T_ULgodGKzSYyBYV3IfYXyVn4RTuZx0" />
							<input type="hidden" name="formTokenRendered" value="Sat, 23 Jan 2021 04:11:45 GMT" />
