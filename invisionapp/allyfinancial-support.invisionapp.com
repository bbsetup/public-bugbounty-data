				...
				<div class="main-panel__table-cell">
					...
					<div class="main-panel__content">
						...
						<form
							...
							<input type="hidden" name="formToken" value="ehOLiEKWe3nyIvh6jHmjzd4sVwSs6MJZUppXciSVIuQ" />
							<input type="hidden" name="formTokenRendered" value="Sat, 23 Jan 2021 02:30:33 GMT" />
