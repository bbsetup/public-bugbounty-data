...
<head>
  ...
  BLG Wonen
    ...
    <meta property="og:url" content="https://beeldbellen.blgwonen.nl/" />
<meta property="og:type" content="website" />
<meta property="og:locale" content="nl" />
<meta property="og:title" content="BLG Wonen" />

<meta property="og:site_name" content="24sessions" />
<meta property="og:image" content="https://s3-eu-west-1.amazonaws.com/24s-saas-config/blgwonen/brand-logo-600x315.png?_um=1606099899" />
...
<link href="https://styles.24sessions.com/ui-theme.css?v=1.72&color=002439" rel="stylesheet" type="text/css" />

  
  <script type="text/javascript">
  window.companyLocale = 'nl';
  window.customLocale = 'nl';
  window.companyLogo = 'https://s3-eu-west-1.amazonaws.com/24s-saas-config/blgwonen/brand-logo.png?_um=1583749106';
  ...
  <script src="/compiled/js/main.js?v=1.72"></script>
    ...
    <script>
        ...
        gtag('config', 'UA-113649025-1', {
            ...
            'instance': 'blgwonen.24sessions.com'
        });
      ...
      <div class="app-header white">
        <div class="navbar">
          <a class="navbar-brand" href="/">
            <img alt="BLG Wonen" src="https://s3-eu-west-1.amazonaws.com/24s-saas-config/blgwonen/brand-logo.png?_um=1583749106">
          </a>
...
<script>
  ...
  <p class="land-header__subtitle text-muted">
    Welkom op onze afspraken pagina. Kies een gesprekstype en volg de instructies om een afspraak met ons te plannen.
                ...
                <div ng-controller="MeetingTypes">
      <div class="land-tiles">
                          
        
                                                  <a href="https://blgwonen.24sessions.com/testmeeting" class="land-tile">
                <span class="land-tile__title">Test meeting</span>
                <span class="land-tile__duration text-muted">
                <i class="fa fa-lg fa-clock-o m-r-xs"></i> 30m
              </span>
              </a>
                          </div>
    </div>
