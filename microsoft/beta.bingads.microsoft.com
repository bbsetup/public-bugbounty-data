...
<html>
<head>
    <title>Microsoft Advertising | Search Engine Marketing (SEM) &amp; more</title>
    ...
    <meta name="description" content="Sign up for Microsoft Advertising. Use our search engine marketing and audience solutions to help you build your business." />
...
<meta name="msapplication-config" content="browserconfig.xml" />
    ...
    <meta name="msapplication-task" content="name=Campaigns;action-uri=https://UI.BETA.ADS.MICROSOFT.COM/Campaign/Campaigns;icon-uri=/favicon.ico" />
    <meta name="msapplication-task" content="name=Accounts;action-uri=https://BETA.ADS.MICROSOFT.COM/cc/Accounts/Index;icon-uri=/favicon.ico" />
    <meta name="msapplication-task" content="name=Billing;action-uri=https://BETA.ADS.MICROSOFT.COM/cc/Billing/History;icon-uri=/favicon.ico" />
    <meta name="msapplication-task" content="name=Tools;action-uri=https://BETA.ADS.MICROSOFT.COM/tools/toolspage.aspx;icon-uri=/favicon.ico" />
    ...
    <script type="application/ld+json">
        ...
        "url": "https://beta.ads.microsoft.com/",
        "logo": "https://advertiseonbing.blob.core.windows.net/blob/bingads/media/library/global/social/bing-ads-200x200-teal.png",
        "sameAs": ["https://www.facebook.com/BingAds", "https://twitter.com/BingAds", "https://www.linkedin.com/company/bing-ads", "https://www.youtube.com/user/BingAds", "http://www.slideshare.net/bingads"]
        }
    </script>
    ...
    <script type="text/javascript">
        function instrumentation() {
            ...
            require.config({
                baseUrl: "https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/login",
                paths: {
                    'legacy': "https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts",
                },
                urlArgs: "v=202102081052198442860",
                waitSeconds: 0, 
                skipDataMain: true,
            });

            define('PageContext', [], {"cid":"","aid":"","uid":"","lcid":"1033","requestId":"be9fa67b-3088-4e73-ab0f-2bd7a6252a1e","sessionId":"0f475a3c-5611-4f34-ae7e-accc00919203","sessionCookieName":"JFX_SessionId","scenarioName":"ManagedLoginLight","ariaToken":"9cf7b68164b34e7e995562121503c72a-72856c17-5747-49e6-bd96-fde5bb08a4f4-7006","device":"Unknown-0.0","FeaturePilotFlag":{"isClientSideLogsUseLocalStorageEnabled":true}});

            require(['PageContext', 'instrumentation/instrumentation', 'instrumentation/pageLoadTime'], function(pageContext, instrumentation, pageLoadTime) {
        ...
        function animateScrollTo(dataSectionName, focusLoginInputs) {
            var target = document.querySelectorAll("[data-section='" + dataSectionName + "']")[0];
            scrollToElement(target);
            if (focusLoginInputs === true) {
                window.displayUsernameSection ? window.showUserNameSection() : window.showPasswordSection();
            }
        };
...
<body>
        ...
        <div id="login-content" data-section="LoginContent">
            <div>
                    ...
                    <nav class="navbar-default navbar-fixed-top" role="banner" container-id="header">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="navbar-collapse" role="navigation">
                                <ul class="nav navbar-nav navbar-center-items">
                                        <li>
                                            <a id="navbarItems_0"
                                               href="javascript:void(0)"
                                               onclick="animateScrollTo('BenefitsSectionViewModel')"
                                               title="Benefits"
                                        ...
                                        <li>
                                            <a id="navbarItems_1"
                                               href="javascript:void(0)"
                                               onclick="animateScrollTo('CostsSectionViewModel')"
                                               title="Cost"
                                               aria-label="Cost">Cost</a>
                                        </li>
                                        <li>
                                            <a id="navbarItems_2"
                                               href="javascript:void(0)"
                                               onclick="animateScrollTo('SuccessStoriesSectionViewModel')"
                                               title="Testimonials"
                                        ...
                                        <li>
                                            <a id="navbarItems_3"
                                               href="javascript:void(0)"
                                               onclick="animateScrollTo('FaqSectionViewModel')"
                                               title="FAQ"
                                               aria-label="FAQ">FAQ</a>
                                        </li>
                                </ul>

                                <ul class="nav navbar-nav navbar-right navbar-right__settings">
                                    <li class="nav-bar-sign-up">
                                        <a class="bing-sign-up-link" href="https://beta.ads.microsoft.com/Signup?s_int=en_us_acsignup_producthp&amp;mcas=0" aria-label="Sign up now">
                                            <span>Sign up now</span>
                                        </a>
                                    </li>
                                    <li class="nav-bar-sign-in">
                                        <a href="javascript:void(0)" class="bing-sign-in-link" aria-label="Sign In" onclick="animateScrollTo('LoginContent', true)">
                                            <span>Sign In</span>
                                        </a>
                                    </li>
                                </ul>
                ...
                <div class="row" id="greenId-frame" style="display: none">
                    <iframe id="IframeHost" name="IframeHost" class="greenIdIFrame" frameborder="0" src="https://fpt.microsoft.com/tags?session_id=0f475a3c-5611-4f34-ae7e-accc00919203"></iframe>
                </div>

                <span id="device-token" style="display:none">
                    <input name="__RequestVerificationToken" type="hidden" value="qTAtb9le4vX9VtZiBXz0kTXb4XpIwMbrv6RPkrxpFxAkcK02adq51I5fldrFmmCiIxhD77L0siSxLjdmE2yYJm5oR3A+hNL0TYYcLWLQwdq/lsZ7y3BDuGsYWGxlQxDx/q0G7w==" />;
                </span>
                <script type="text/javascript">
                        function deviceInfo() {
                            ...
                            return {
                                devicePixelRatio: typeof ("undefined" !== window.devicePixelRatio) ? window.devicePixelRatio : 0,
                        ...
                        var antiForgeryToken = document.querySelector('#device-token input').value;
                        var http = new XMLHttpRequest();
                        var url = "https://beta.ads.microsoft.com/Login/DeviceHash";
                        var deviceHashData = new FormData();
                        deviceHashData.append('__RequestVerificationToken', antiForgeryToken);
                        deviceHashData.append('dhash', stringToHash(JSON.stringify(deviceInfo())));
                        http.open('POST', url, true);
                        http.send(deviceHashData);
                </script>
            ...
            <div id="mktContent">
                ...
                <section class="alerts">
                        ...
                        <div id="pageAlertsLogin" style="display: block;">
    <div class="alert alert-danger alert-dismissable">
        <button type="button" class="closeimage alert-ignore" data-dismiss="alert" aria-hidden="true" onclick="removeAlert(this)"></button>
        <span>Please enable your Internet browser to accept cookies and make sure that JavaScript is enabled. If you aren’t sure how to do this, refer to your browser’s Help. <a href="http://advertising.microsoft.com/MSNKeywords/LearningCenter/Troubleshooting.asp">Here&#39;s how</a></span>
    </div>
                        </div>
                ...
                <div id="heroDiv" class="hero-unit">
                    <div class="row">
                        <!-- Even of no heroSection defined, in any case we are displaying the login section here -->
                        <div class="hero-right col-sm-4 col-sm-push-8 ">
                            <div class="signInContainer">
                                ...
                                <form action="/default.aspx" id="loginForm" method="post">
                                    <input name="__RequestVerificationToken" type="hidden" value="R0RVUPbGgRQhKjAEfmb/3PDhJR47LFkymoqaN24xGF5fbu41pxnp5gkkAucyxu1hpLJHCWtsy9nzpEnHhRuaEye+uD9L89/RKn0GQyN99DXZVCB3MHVGkzuAD8n5wFcyttDoNQ==" />

                                    <div class="enter-user-name-section">
                                        ...
                                        <h2 class="hero-title-header">Already use Microsoft Advertising?</h2>

                                        <p class="hero-title-description">Enter your user name or email address to sign in:</p>

                                        <input MaxLength="254" aria-describedby="inlineErrorLogin" aria-label="Enter your user name or email address" class="hero-login-textbox form-control" id="LoginModel_Username" name="LoginModel.Username" placeholder="Enter your user name or email address" type="text" value="" />
                                        ...
                                        <p class="forgot-username">
                                            <a id="forgotUsernameLink" href="https://beta.ads.microsoft.com/ForgotPassword" aria-label="Forgot your user name?">
                                                <span>Forgot your user name?</span>
                                            </a>
                                            <a id="forgotPasswordLink" class="moveOffScreen" tabindex="-1" href="https://beta.ads.microsoft.com/ForgotPassword?recoverPassword=True" aria-label="Forgot your password?">
                        ...
                        <div class="hero-left col-sm-8 col-sm-pull-4">
                            

    <style type='text/css'>
        .hero-img::after {
            background-image: url("https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/login/markets/en-us/img/hero_short_016v3.jpg");
    ...
    <div class="hero-img ">
        <div class="hero-content ">
            <div>
                <h1 class="hero-title-header">

    <span class="">Millions are searching.<br/>Make sure they find you.</span>

</h1>
                <p class="hero-text1">

    <span class="">Reach customers looking for your business. Use the Microsoft Search Network to connect with an audience that searches 7.3 billion times a month.<span class="sup">1</span> </span>

</p>
                <div class="hero-button-sign-up">
                    <p>
                        <a id="heroContentButton" href="https://beta.ads.microsoft.com/Signup?s_int=en_us_acsignup_producthp&amp;mcas=0" aria-label="Sign up for Microsoft Advertising">Sign up now</a>
                    </p>
                </div>
                <p class="hero-text2">

    <span class="">Have a question? Please call us at <span class="phone">877-635-3561</span>.</span>

</p>
                <p class="footnote">

    <span class="">1. Comscore qSearch, Explicit Core Search (custom), September 2020, United States, desktop traffic only.</span>
                ...
                <div id="benefitsDiv" class="benefits-template" data-section="BenefitsSectionViewModel">
    ...
    <span class="">Powerful network. Powerful benefits.</span>
    ...
    <div class="benefit col-md-4 col-lg-4">
        <div class="image-cropper">
            

    <img src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/login/markets/en-us/img/Benefit1.jpg"
         class="rounded"
         alt="REACH ACROSS DEVICES"
    ...
    <span class="">REACH ACROSS DEVICES</span>

</h3>
        <p>Connect with customers who are looking for your products and services at home, at work or on the go.</p>
    </div>
    ...
    <img src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/login/markets/en-us/img/Benefit2.jpg"
         class="rounded"
         alt="GO GLOBAL OR LOCAL"
         style="opacity: 100; filter: alpha(opacity=100); -ms-filter: &quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=100)&quot;; -moz-opacity: 1; -khtml-opacity: 1;"
    ...
    <span class="">GO GLOBAL OR LOCAL</span>

</h3>
        <p>Reach millions of unique searchers on the Microsoft Search Network — by country, city or within a specific distance.</p>
    </div>
    ...
    <img src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/login/markets/en-us/img/Benefit3.jpg"
         class="rounded"
         alt="EASY TO IMPORT"
         style="opacity: 100; filter: alpha(opacity=100); -ms-filter: &quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=100)&quot;; -moz-opacity: 1; -khtml-opacity: 1;"
    ...
    <span class="">EASY TO IMPORT</span>

</h3>
        <p>If you&#39;re already using another product like Google Ads, it&#39;s easy to pull that campaign into Microsoft Advertising.</p>
    </div>
                ...
                <div id="costsDiv" class="costs-template" data-section="CostsSectionViewModel">
                    

    <div class="container-fluid costs-section">
        <div class="row">
            <div class="head">
                <h2>
    ...
    <span class="">Keep costs in check</span>
                ...
                <p>Use our tools to help manage your campaigns and meet your advertising goals. Whether that is working with a fixed budget or trying to hit a cost per acquisition or action, Microsoft Advertising gives you the control to make that happen. </p>
            </div>
            <div class="costs">
                

    <div class="cost col-sm-6 col-md-6 col-lg-6">
        <p class="cost-check">
            <span class="checked-icon"></span>
        </p>
        <h3>

    <span class="">NO MINIMUM FEE</span>

</h3>
        <p class="cost-description">Sign up for free and start advertising with any budget.</p>
    </div>
    ...
    <span class="">ONLY PAY FOR CLICKS</span>

</h3>
        <p class="cost-description">Pay just when customers click your ad. No click, no charge.</p>
    </div>
    ...
    <span class="">MEASURE PERFORMANCE</span>

</h3>
        <p class="cost-description">Test keywords, bids and timing to make the most of your ROI.</p>
    </div>
    ...
    <span class="">BUDGET BY THE DAY</span>

</h3>
        <p class="cost-description">Set a budget or adjust your spending daily.</p>
    </div>
                ...
                <div id="successStoriesDiv" class="success-stories-template" data-section="SuccessStoriesSectionViewModel">
    ...
    <img src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/login/markets/en-us/img/cj-pony-customer-story-gbl-1300x600.jpg"
         
         alt="CJ pony testimonial"
         style="opacity: 100; filter: alpha(opacity=100); -ms-filter: &quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=100)&quot;; -moz-opacity: 1; -khtml-opacity: 1;"
         width="100%"
        ...
        <div class="carousel-container">
            <div class="carousel-caption">
                <div class="carousel-content">
                        <span class="quote quoteLeft textWhite">"</span>
                        <h2 class="textWhite">

    <span class="">The advantage we gain in cost per click gives us a great return on investment — more than 35 percent better than Google Ads.</span>

</h2>
                        <span class="quote quoteRight textWhite">"</span>
                    <div class="author-div">
                        <p class="author textWhite">

    <span class="">Scott Redgate</span>

</p>
                        <p class="position textWhite">

    <span class="">Search Engine Marketing Manager, CJ Pony Parts</span>

</p>
                    </div>
                    <p class="quotation textWhite">

    <span class="">By using Microsoft Advertising features like Image Extensions and Sitelink Extensions, this auto parts retailer races to convert customers and beat its competition.</span>
    ...
    <img src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/login/markets/en-us/img/myrtle-beach-gbl-1300x600.jpg"
         
         alt="Myrtle beach testimonial"
         style="opacity: 100; filter: alpha(opacity=100); -ms-filter: &quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=100)&quot;; -moz-opacity: 1; -khtml-opacity: 1;"
         width="100%"
    ...
    <span class="">We might not get as much of the volume as with Google Ads, but the volume of traffic that we get converts really well at a lower cost.</span>
    ...
    <span class="">Scott Schult</span>

</p>
                        <p class="position textWhite">

    <span class="">Executive Vice President of Marketing, Myrtle Beach Area Convention and Visitors Bureau</span>

</p>
                    </div>
                    <p class="quotation textWhite">

    <span class="">The Myrtle Beach Area Convention and Visitors Bureau uses Microsoft Advertising to drive site traffic and tourism at lower cost.</span>
    ...
    <img src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/login/markets/en-us/img/motoroso-customer-story-gbl-1300x600.jpg"
         
         alt="Motoroso testimonial"
         style="opacity: 100; filter: alpha(opacity=100); -ms-filter: &quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=100)&quot;; -moz-opacity: 1; -khtml-opacity: 1;"
         width="100%"
    ...
    <span class="">Better results for less cost. That's as simple as I can make it. If I look at the quality of traffic we get for  the dollars we spend on Bing Ads, our ROI is fantastic.</span>
    ...
    <span class="">Alex Littlewood</span>

</p>
                        <p class="position textWhite">

    <span class="">CEO, Motoroso</span>

</p>
                    </div>
                    <p class="quotation textWhite">

    <span class="">Motoroso, a market network for auto enthusiasts, gets better results for less cost and reaches a high-value audience with Microsoft Advertising.</span>
                ...
                <a href="#myCarousel" id="carouselArrowPrevious" data-slide="prev" class="left carousel-control" role="button">
                    <span class="glyph-caret-left arrows"></span>
                    <span class="sr-only">Previous success story</span>
                </a>
                <a href="#myCarousel" id="carouselArrowNext" data-slide="next" class="right carousel-control" role="button">
                ...
                <div id="previewDiv" class="preview-template" data-section="PreviewSectionViewModel">
                    


                </div>

                <div id="faqDiv" class="faq-template" data-section="FaqSectionViewModel">
    ...
    <span class="">FAQ</span>
            ...
            <div class="faqs">
                    <div class="faq-cluster">
                        <h3 id="faqTitleCategory_0" aria-expanded="false" class="clickable not-active subTitleCssClass" tabindex="0" role="button" onclick="collapseFaq('0')">
                            <span>About Microsoft Advertising</span>
                            <span class="caret-down-icon"></span>
                        </h3>
                        <div id="faqContentCategory_0" style="display: none; overflow: hidden;">
                                <div class="faq">
                                    <h4 class="questionCssClass">How does Microsoft Advertising work?</h4>
                                    <p class="">

    <span class="">Customers search.<br/>People enter search terms called keywords into search engines like Bing.<br/><br/>Customers see your ad.<br/>If the keywords in your ad match a search, your ad appears next to or above search results on Bing.<br/><br/>Customers contact you.<br/>You can configure your ad so people can call you, visit your website or go right to your door.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">Who does Microsoft Advertising reach?</h4>
                                    <p class="">

    <span class="">Bing powers 37.5% of U.S. desktop searches<span class="sup">1</span> and 13.9 billion monthly searches around the globe,<span class="sup">2</span> plus connects you with 44.2 million searchers that Google can't reach.<span class="sup">1</span> In fact, 27 percent of our clicks come from searches that are exclusive to the Microsoft Search Network.<span class="sup">3</span>  <br/>In the U.S., the Microsoft Search Network has 138 million unique searchers.<span class="sup">1</span> </span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">What is the Microsoft Search Network?</h4>
                                    <p class="">

    <span class="">Microsoft Search Network is a part of your customers’ life, powering the devices, apps and sites they use every day and meeting them in the moments that matter most. <br/>Searchers find the Microsoft Search Network on Bing and partner sites, through Windows 10, Cortana and Office, plus across third-party platforms and partnerships — whether it’s search inside Amazon’s devices, web results for Siri and Spotlight Search on Apple devices, or maps on thousands of leading websites. </span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">How does the Microsoft Search Network differ from Microsoft Advertising?</h4>
                                    <p class="">

    <span class="">The Microsoft Search Network consists of Bing and partner sites. It’s where your business can reach a large and unique audience made up of millions of people who search every day. Use the advertising platform Microsoft Advertising to connect with these valuable potential customers.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">Where does my ad appear?</h4>
                                    <p class="">

    <span class="">Your ads could appear on the top or to the right of Bing, Yahoo and MSN search results. And you can choose to target your ads to different geographic regions, times or days of the week, and even demographics.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">What determines my ad position?</h4>
                                    <p class="">

    <span class="">Microsoft Advertising is a pay-per-click (PPC) advertising system. You bid based on how much you are willing to pay per each click on your ad. Because webpages have a limited number of places to show ads, we auction those spaces. You are bidding against other advertisers to get your ads into the space you want. So if you bid on the keyword "shoe", you will have to beat the bids of the other advertisers who are also bidding on "shoe." You determine how much you are willing to bid. Your ad position is based on several things, including: <br/> 1. How closely your ad and website fit with the terms that are searched (relevance).<br/>2. How your bid compares to other bids in the Microsoft Advertising auction.<br/>3. How strongly your ad has performed in the past and how often it has been clicked (click-through rate).<br/>The stronger you are in these areas, the better your chances of winning the top ad position.</span>
                    ...
                    <div class="faq-cluster">
                        <h3 id="faqTitleCategory_1" aria-expanded="false" class="clickable not-active subTitleCssClass" tabindex="0" role="button" onclick="collapseFaq('1')">
                            <span>Is Microsoft Advertising right for me?</span>
                            <span class="caret-down-icon"></span>
                        </h3>
                        <div id="faqContentCategory_1" style="display: none; overflow: hidden;">
                                <div class="faq">
                                    <h4 class="questionCssClass">Is Microsoft Advertising right for my business?</h4>
                                    <p class="">

    <span class="">All types of businesses find value and success with Microsoft Advertising. Whether you’re focused on local calls and foot traffic, or want to drive traffic to your website from across the country or around the world, Microsoft Advertising has solutions for you.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">I already appear in search results for free. Why should I pay for advertising?</h4>
                                    <p class="">

    <span class="">Your current customers may search for your business by name, making it easy to find you in search results. But customers you’ve yet to reach are more likely searching for general terms that wouldn’t necessarily bring up your business in search results. Advertising next to relevant Bing search results puts your business front and center with interested customers you otherwise might not reach.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">What is the difference between SEO and SEM? Which one is right for me?</h4>
                                    <p class="">

    <span class="">Search engine optimization (SEO) is adjusting your website to improve your natural ranking in search results. You cannot pay to improve your website ranking on Bing or Yahoo, thus we often refer to these results as unpaid or “organic” search results.<br/> Clicks from SEO are free. But SEO also requires technical expertise and involves some factors over which you have only limited control. <br/> Search engine marketing (SEM) is paid advertising that appears next to or above unpaid (or “organic”) search results. These paid ads are purchased through Microsoft Advertising. <br/> You pay for SEM clicks. But SEM gives you more control over when your website appears on results pages and you decide how much you want to pay. And you can measure which ads are working and quickly improve your results. <br/> You don’t have to choose between SEO and SEM. You can do both!</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">If my time is limited, should I still try Microsoft Advertising?</h4>
                                    <p class="">

    <span class="">Yes! Call a Microsoft Advertising specialist at 877-635-3561* and we’ll set up your first campaign for you for free. We’ll give you tips on getting the most out of your ads and set you up for success. We’re here to help.</span>
                    ...
                    <div class="faq-cluster">
                        <h3 id="faqTitleCategory_2" aria-expanded="false" class="clickable not-active subTitleCssClass" tabindex="0" role="button" onclick="collapseFaq('2')">
                            <span>How to use Microsoft Advertising</span>
                            <span class="caret-down-icon"></span>
                        </h3>
                        <div id="faqContentCategory_2" style="display: none; overflow: hidden;">
                                <div class="faq">
                                    <h4 class="questionCssClass">How can I use Microsoft Advertising to drive more people to my website?</h4>
                                    <p class="">

    <span class="">Here are some tips to get better results: <br/><br/>◦ Review your budget and bid strategy. If your ads keep pausing, your budget limit may be set too low. Competitive bids help your ad stay in a strong position to catch eyes and get more clicks to your website.<br/>◦ Expand your targeting, both for location and for devices (computer, mobile and tablet).<br/>◦ Make sure your ads and website are relevant to the keywords you bid on. Would someone searching your terms expect to see an ad for your business?</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">How can I keep my costs down?</h4>
                                    <p class="">

    <span class="">While your first instinct may be to lower your budget, first try lowering your maximum bids. Yes, this could mean fewer customers visit your site. But if you increase your quality score and build ads with a strong performance history, you may be able to win a good ad position with a lower bid. That would lower your cost per click and help stretch your budget.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">How do I know if Microsoft Advertising is working?</h4>
                                    <p class="">

    <span class="">View a wide range of performance trends in your account to quickly see key stats: ad clicks, the number of times your ad appeared (impressions), spend, average cost per click, click-through rate, average ad position, cost per acquisition and conversions. You can also run performance reports to get insights into how well your campaigns are doing.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">Can I run more than one ad?</h4>
                                    <p class="">

    <span class="">Yes! In fact, we encourage it. Only one ad will show at a time but running multiple ads lets you test different approaches to see what’s working best with your target customers. Frequently, businesses try out different ads for specific products or pages.</span>
                    ...
                    <div class="faq-cluster">
                        <h3 id="faqTitleCategory_3" aria-expanded="false" class="clickable not-active subTitleCssClass" tabindex="0" role="button" onclick="collapseFaq('3')">
                            <span>Getting started with Microsoft Advertising</span>
                            <span class="caret-down-icon"></span>
                        </h3>
                        <div id="faqContentCategory_3" style="display: none; overflow: hidden;">
                                <div class="faq">
                                    <h4 class="questionCssClass">How do I get started?</h4>
                                    <p class="">

    <span class="">Sign up for Microsoft Advertising.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">Which keywords should I choose?</h4>
                                    <p class="">

    <span class="">You have a few options to help choose your keywords. First you’ll want to think of the terms one of your customers might use to search for your products and offerings. Those search terms are a great starting point. Then you can use tools right in your account to find more keywords. <br/><br/>Within Microsoft Advertising, click Campaigns on the top of the page, click the Keywords tab, and then click Add Keywords. This will let you:<br/>◦ Search for new keywords based on one you enter.<br/>◦ Search a website for keywords.<br/>◦Search your destination URLs for keywords.</span>

</p>
                                </div>
                                <div class="faq">
                                    <h4 class="questionCssClass">How can I write a good ad?</h4>
                                    <p class="">

    <span class="">Here are a few tips that can help make your ad stand out.<br/><br/> ◦ Keep your ads relevant. One way to improve relevance is to use your customers' most popular search terms in your ad titles and text.<br/>◦ Describe what sets your product apart.<br/>◦ Use your customers' language. Use words and a writing tone that are likely to attract your typical customer.<br/>◦ Be specific. The clearer and more specific the offering, the better. For example, rather than "big discounts," specify an exact percentage, such as "50 percent off."<br/>◦ Give customers a reason to click your ad right now. Offer a specific call to action, such as encouraging customers to request a brochure or consultation, download a free e-book, subscribe to a newsletter, or take advantage of a limited-time discount.</span>
                ...
                <div id="footNoteDiv" class="footnote-template">
                            <p class="footnote">
    ...
    <span class="">2. Comscore qSearch (custom), September 2020, Worldwide, desktop traffic only.</span>

</p>
                            <p class="footnote">

    <span class="">3. U.S. click data from Microsoft internal data, July 2017.</span>
...
<footer>
    <nav class="navbar-footer navbar-fixed-bottom" role='contentinfo'>
        <div class="container-fluid">
            <ul class="nav navbar-nav navbar-nav-footer">
                <li><span>&copy; 2021 Microsoft</span></li>
        ...
        <li><a href="http://go.microsoft.com/fwlink/?LinkId=268769"  target="_blank">Developers</a></li>
    ...
    <script type="text/javascript">
        var mainModel = {"ForgotPasswordCredentialLink":"https://beta.ads.microsoft.com/ForgotPassword?recoverPassword=True","InlineError":null,"WlidAuthUrl":"https://login.live.com/login.srf?wa=wsignin1.0\u0026rpsnv=13\u0026ct=1613033400\u0026rver=7.0.6730.0\u0026wp=MBI_SSL\u0026lc=1033\u0026id=288120\u0026lw=1\u0026fl=email%2cflname\u0026uaid=be9fa67b30884e73ab0f2bd7a6252a1e","WlidRurl":"https://ui.beta.ads.microsoft.com/campaign/login/live","LoginModel":{"Username":null,"Password":null,"KeepMeSignedIn":false},"DefaultDomains":["outlook.com","hotmail.com","live.com","gmail.com","yahoo.com","aol.com","msn.com","outlook.de","outlook.fr","hotmail.co.uk","outlook-int.com"],"UseLoginHints":true};
        mainModel.GlobalResources = {"SignIn_title":"Already use Microsoft Advertising?","SignIn_EnterUserNameOrEmail_title":"Enter your user name or email address to sign in:","SignIn_Password_title":"Hi","SignIn_EnterPassword_title":"Enter your password to sign in:","MoonshotHome_UserNameIsRequired":"Please enter your user name or email address.","UseMsaForLoginMessage":"To sign in using your email address, go to {0}.","SignIn_UserNameInvalid":"This user name/email address is invalid. Please check and reenter your user name/email address.","MoonshotHome_PasswordIsRequired":"Please enter your password."};
...
/** Variables **/
var jqueryPromise = createPromise();
var logPromise = createPromise();
...
if (mainModel.LoginModel.Username) {
    handleUserNameAction();
}

if (mainModel.InlineError) {
    setInlineErrorMessage(mainModel.InlineError);
}
...
function handleUserNameAction() {
    ...
    if (userNameError) {
        if (userNameError === mainModel.GlobalResources.UseMsaForLoginMessage && mainModel.WlidAuthUrl) {
            getLoginUrl(username, mainModel.WlidAuthUrl).then(function (url) {
                redirect(url);
            });
        } else {
...
function showUserNameSection() {
    ...
    heroTitleHeader.innerHTML = mainModel.GlobalResources.SignIn_title;
    removeClass(heroTitleHeader, constants.CSS_CLASS.WELCOME_USER);
    heroTitleDescription.innerHTML = mainModel.GlobalResources.SignIn_EnterUserNameOrEmail_title;
...
function showPasswordSection() {
    ...
    heroTitleHeader.innerHTML = mainModel.GlobalResources.SignIn_Password_title + " " + usernameInput.value;
    addClass(heroTitleHeader, constants.CSS_CLASS.WELCOME_USER);
    heroTitleDescription.innerHTML = mainModel.GlobalResources.SignIn_EnterPassword_title;
...
function getLoginUrl(username, defaultUrl) {
    ...
    if (!mainModel.UseLoginHints || (mainModel.DefaultDomains || []).indexOf(userDomain) !== -1) {
        return {
    ...
    function setLoginQuery(url) {
        ...
        return (wreplyStart > 0 && url.substring(0, wreplyStart) || url) +
            ...
            '&wreply=' + encodeURIComponent(mainModel.WlidRurl);
    }
}

function setOffScreenElements() {
...
function getUserNameError(userName) {
    if (!userName) {
        return mainModel.GlobalResources.MoonshotHome_UserNameIsRequired;
    }
    if (constants.REG_EXP.MSA_USER.test(userName)) {
        return mainModel.GlobalResources.UseMsaForLoginMessage;
    }
    if (!constants.REG_EXP.MANAGED_USER.test(userName)) {
        return mainModel.GlobalResources.SignIn_UserNameInvalid;
    }
...
function getPasswordError(password) {
    if (!password) {
        return mainModel.GlobalResources.MoonshotHome_PasswordIsRequired;
    }
    return constants.EMPTY_STR;
}
...
function getRecoverPasswordQueryString() {
    var url = mainModel.ForgotPasswordCredentialLink;
...
if (window.performance && window.performance.mark) {
    window.performance.mark('LoginLightUsernameSectionReady');
}

usernameInput.focus();
    </script>

<script type="text/javascript" src="//advertiseonbing-blob.azureedge.net/blob/launch/product/prd/5ef092d1efb5/2a6ab4a42773/launch-33d1ae778898.min.js" async></script>

    <link rel="stylesheet" type="text/css" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/styles/login-icons.css?v=202102081052198442860" />

        <script type="text/javascript" src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-login-core-libs-light.js?v=2017.06.27" crossorigin="anonymous"></script>
    <script type="text/javascript">
        ...
        if (window.performance && window.performance.mark) {
            window.performance.mark('LoginLightMarketingContentReady');
        }
    </script>

        <script type="text/javascript" src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-login-libs-prelogger.js?v=0794be29cefc5495232da79c2860910a" crossorigin="anonymous"></script>
        <script type="text/javascript" src="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-logger.js?v=67683b0ae4778962d708586b1b7ff5dd" crossorigin="anonymous"></script>
        <script type="text/javascript">
            instrumentation();
        </script>
...
<script language="javascript" type="text/javascript">
    ...
    _PDL.serverName = "beta.ads.microsoft.com";
</script>
    </div>
...
<script type="text/javascript">
    ...
    window.WcpConsent && WcpConsent.init("en-us", 'consent-banner', function (err, _siteConsent) {
        if (!err) {
...
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/bingads-lib.js?v=cc1000bb07f859d6776cc8bb73f5a741" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/bingads-lib-ext.js?v=ef1268c3a4d6eb3c2e89f2f1c48c7585" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/bingads-webui-common.js?v=c2c40073ed9d9b50517d11eaebc205de" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-feature-common.js?v=1f61e1caea5f8c6279f07d96184410a4" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-app.js?v=596fdd0b2590e59bb792a8124bbb3bca" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/bingads-webui-accounts.js?v=586d5c66b5fa080189f34c3ad715b34f" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-feature-accounts.js?v=5d51307b89d7be6278f0fcefafc2f0c6" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-lib.js?v=78ea1cfe8a0fdbe5e6dd47cb75759da3" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-signup-lite.js?v=202102081052198442860" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/app/bundle/fabric-control.js?v=823723bb4c9e811fbb818c20c21d78d6" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/app/bundle/react-jss.js?v=202102081052198442860" crossorigin="anonymous" />
<link rel="prefetch" as="stylesheet" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/styles/modernui-theme.css?v=93dec581025be34687f0b87cb9834451" />
<link rel="prefetch" as="stylesheet" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/styles/glyph-icons.css?v=202102081052198442860" />
<link rel="prefetch" as="stylesheet" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/styles/modernui-theme-2018.css?v=c59aab980bafe3de81a8e4d963fc93fc" />
<link rel="prefetch" as="stylesheet" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/styles/glyph-icons-2018.css?v=202102081052198442860" />

    <link rel="preconnect" href="https://ui.beta.ads.microsoft.com" />
    <div id="campaign-prefetch-links"></div>
    <script type="text/javascript">
    (function() {
        function getPrefetchLink(type, url) {
            var $link = $('<link rel="prefetch" crossorigin="anonymous" />');
            $link.attr('as', type).attr('href', url);
            return $link[0].outerHTML;
        }

        var container = $('#campaign-prefetch-links');

        $.get('https://ui.beta.ads.microsoft.com' + '/Campaign/API/PrefetchedResources/Get',
        function(data) {
            var htmlToInject = data.Links.reduce(function(html, link) {
                return html + getPrefetchLink(link.Type, link.Url);
            }, '');

            container.html(htmlToInject);
        });
    })();
    </script>

<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-grid.js?v=2c6a45fe2ebbefb0b524aaa4c854aaa7" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/ccui-consolidatedbilling.js?v=ec467c6ec6ad8cecfdbe8ea8df35c106" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/en-US.js?v=202102081052198442860" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/app/clientcenter/@bingads-webui-universal/i18n-cldr-data-modern/core.json?v=202102081052198442860" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/app/clientcenter/@bingads-webui-universal/i18n-cldr-data-modern/locales/en.json?v=202102081052198442860" crossorigin="anonymous" />
<link rel="prefetch" as="script" href="https://beta-resources-bingadsms.azureedge.net/ClientCenter.v2/scripts/app/bundle/feature/settings/settings.js?v=202102081052198442860" crossorigin="anonymous" />
