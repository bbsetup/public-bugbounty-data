...
<head>
    ...
    <title>Free Online Bet Calculator | Paddy Power</title>
    <meta name="description" content="Check your potential winnings on accumulators, Lucky 15s and all your favourite bets with Paddy Power online bet calculator." />
...
<header class="widget-calculator-header">
    <a href="https://www.paddypower.com/bet" target="_blank" class="hover-intent">
        <img src="/img/paddy-power-logo.svg" alt="Paddy Power logo in white." />
    </a>
</header>
...
<footer class="widget-calculator-footer">
    <img src="/img/timeform-logo.png" alt="Timeform logo in white, on a transparent background." />
    <span>
        Powered by 
