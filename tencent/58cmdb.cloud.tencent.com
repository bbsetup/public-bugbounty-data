        ...
        <div class="page-content">
            <div class="login-from">
                ...
                <div class="from-detail">
                    <form action="" method="post" id="login-form" onsubmit="return refresh_token()"><input type='hidden' name='csrfmiddlewaretoken' value='SXuocfGbn5geVQMXmdH1L2axJC4H1I02' />
                        ...
                        <div class="form-login">
                            ...
                            <div>
                                ...
                                <input type="hidden" name="app_id" value="bk_cmdb">
                            </div>
