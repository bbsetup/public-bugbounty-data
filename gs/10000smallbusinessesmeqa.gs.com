...
<main   style="background-color: #00355F;" >
  ...
  <div id="gs-logo" class="gs-logo-container__logo">
    ...
    <div id="gs-login-form-container" class="gs-login-form-container">
      ...
      <form id="request-access-code-form" action="/as/3rMEw/resume/as/authorization.ping" method="post" hidden>
      ...
      <form
        ...
        name="loginform"
        action="/as/3rMEw/resume/as/authorization.ping"
        method="post"
        autocomplete="off"
        novalidate
      >
  ...
  <p class="gs-login-alert--warning" id="password-validation-error-alert" hidden>
    ...
    <label for="remember-me">Remember me</label>
      ...
      <form action="/as/3rMEw/resume/as/authorization.ping" method="post" id="cancel-form" hidden>
