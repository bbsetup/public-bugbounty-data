    ...
    <div class="container-fluid">
        ...
        <div class="bottom-half center-block">
            ...
            <form action="authenticate.cgi" method="post" autocomplete="off">
                <input type="hidden" name="referpg" value="aHR0cHM6Ly9hbXBmLnNlbGVjdC5ncy5jb20v" />
                ...
                <input type="hidden" name="http_referer" value="ampf.select.gs.com">
                ...
                <div class="row space-bottom">
                    <div class="col-sm-4 col-xs-4">
                        <a href="https://webid2.gs.com/pwdreset/colt/username">Forgot Password?</a>
                    </div>
