...
<body>
    <div class="container">
        ...
        <div class="descr">
            <p>The connection to site api-gost-test.qiwi.com is not established - it does not respond.</p>
            <p>Try accessing the site api-gost-test.qiwi.com later or contact administration of the site.</p>
        </div>
        ...
        <div class="footer">
            <div class="guru">
                ...
                Request: GET Lw==<br/>
                Guru meditation: Z0lGbEcyb0lBWmU0NzEyRWFkSVpnU1RjazJpMDAwNTI=<br/>
            </div>
        </div>
