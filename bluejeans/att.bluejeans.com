...
margin-right: auto;
margin-left: auto;
background: transparent url('/sites/default/files/logo-att-video-meetings-with-blue-Jeans.png') no-repeat 0 10px;
}.plp_header a {
display: block;
float: right;
height: 36px;
...
form.vals({"GA_trackId__c":"att_na"});
