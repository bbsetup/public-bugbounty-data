...
<link href="https://static.bluejeans.com/z0/webapp-assets/css/CLP/bcm-clp.css" rel="stylesheet" type="text/css"
	...
	<div id="clp_content">
		<div id="clp_boxes">
				...
				<div id="login">
					...
					<a id="forgot-password-link" href="https://pwss.bcm.tmc.edu/">Forgot your password?</a>
			...
			<div id="attend">
				...
				<div style='display:none'><input type='hidden' name='csrfmiddlewaretoken' value='cEoXjfnMOpQatU7uzF658lc5YFqmxvF1' /></div>
				
				<iframe src="/iframe/attend/?ll=en-gb&CLP=1615" ALLOWTRANSPARENCY="true"
