...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="//img.staticmy.com/s/images/favicon/favicon.ico"/>
    <link rel="image_src" href="//img.staticmy.com/s/images/favicon/favicon.ico"/>
    ...
    <link rel="apple-touch-icon" href="//img.staticmy.com/s/images/favicon/favicon.ico"/>
    <link rel="apple-touch-icon" sizes="76x76" href="//img.staticmy.com/s/images/favicon/favicon.ico"/>
    <link rel="apple-touch-icon" sizes="114x114" href="//img.staticmy.com/s/images/favicon/favicon.ico"/>
    <link rel="apple-touch-icon" sizes="152x152" href="//img.staticmy.com/s/images/favicon/favicon.ico"/>
    <script src="//account.my.com/build/css/accounts/profile.js?v=20201030.1554-175"></script>
</head>
<body class="">
<script>
    window.__GMCS = {"lang":"en_US","signup_soc_steam":1,"signup_captcha":"recaptcha","current_mc_user":{"ds_reg_error_code":6281,"error_message":"Internal error. Please try again later","status":"400","error":"no auth","error_code":415},"auth":0,"failure":"https://account.my.com/login/?continue=https%3A%2F%2Faccount.my.com%2Fprofile%2Fuserinfo%2F","langs_available":"all","signup_soc_ps":1,"continue":"https://account.my.com/profile/userinfo/","navigation_project_logo":"home"};
</script>
...
<script type="text/x-template" id="tmplVerification">
    ...
    <div class="js_navigation_container">
        <span itemscope itemtype="http://schema.my.com/ph-logo" style="display: none">
            <meta itemprop="project" content="home" />
...
<script type="text/x-template" id="tmplNavigation">
    ...
    <div class="js_navigation_ph">
        ...
        <img src="https://r.my.com/d16722803.gif?sz=40&amp;rnd=149475018&ts=1611350691&sz=40" style="width:0;height:0;position:absolute;visibility:hidden;" alt=""/>
...
<div class="mcLayout mcLayout_page mcLayout_amc mcTHolder mcBg4">
    <div class="mcTRow mcTRow_main">
        <div class="mcHolder mcHolder_narrow">
            <div class="mcRow">
                <div class="mcCell mcCell_all">
                    <div class="mcPage mcPage_single">

<div class="mcApi">
    <a class="mcModal_close js-modalClose" title="Close"></a>

    <div class="formWrapper">
        <form id="login_form" method="post" action="https://auth-ac.my.com/auth" class="js_login_form">
            <div class="formContainerG formContainer_top">
                <h3 class="formTitle">Log In</h3>
                <ul class="formHolder formHolderNarrow">
                    <li class="formItem formItem_email">
                        <input type="text" name="email" id="email" class="mcInput wide" value="" placeholder="Email or mobile phone number">
                    </li>
                    <li class="formItem formItem_pwd">
                        <input type="password" name="password" id="password" class="mcInput wide" value="" placeholder="Password">
                    </li>
                    <li class="formItem formItem_checkbox">
                        <a href="https://account.my.com/password_reset/" class="pull-left ext-forgotPasswdLink">Forgot your password?</a> &nbsp;
                        <div class="pull-right ext-rememberCheckbox">
                            <label for="remember"><input type="checkbox" name="" id="remember" class="js_login_remember" checked> Remember me</label>
                        </div>
                    </li>

                </ul>
            </div>
            <div class="formContainer formBottom formContainer_bottom">
                <ul class="formHolder formHolderNarrow">
                    <li class="formItem formItem_btn">
                        <div class="pull-left ext-loginBtns">
                            <button type="submit" class="mcBtn" value="LOG IN">LOG IN</button>
                            <a href="https://account.my.com/signup/?continue=https%3A%2F%2Faccount.my.com%2Fprofile%2Fuserinfo%2F" class="mcBtn mcBtnLight js_login_signup">SIGN UP</a>
                        </div>
                        <div class="formFooterIcons pull-right">
                                    <a class="js_social_login" data-soc="fb" href="https://auth-ac.my.com/social/fb?continue=https%3A%2F%2Faccount.my.com%2Fsocial_back%2F%3Fcontinue%3Dhttps%253A%252F%252Faccount.my.com%252Fprofile%252Fuserinfo%252F&failure=https%3A%2F%2Faccount.my.com%2Fsocial_back%2F%3Fsoc_error%3D1%26continue%3Dhttps%253A%252F%252Faccount.my.com%252Fprofile%252Fuserinfo%252F">
            <img src="//account.my.com/img/common/oauth_fb.png">
        </a>
        <a class="js_social_login" data-soc="tw" href="https://auth-ac.my.com/social/tw?continue=https%3A%2F%2Faccount.my.com%2Fsocial_back%2F%3Fcontinue%3Dhttps%253A%252F%252Faccount.my.com%252Fprofile%252Fuserinfo%252F&failure=https%3A%2F%2Faccount.my.com%2Fsocial_back%2F%3Fsoc_error%3D1%26continue%3Dhttps%253A%252F%252Faccount.my.com%252Fprofile%252Fuserinfo%252F">
            <img src="//account.my.com/img/common/oauth_tw.png">
        </a>
        <a class="js_social_login" data-soc="steam" href="https://auth-ac.my.com/social/steam?continue=https%3A%2F%2Faccount.my.com%2Fsocial_back%2F%3Fcontinue%3Dhttps%253A%252F%252Faccount.my.com%252Fprofile%252Fuserinfo%252F&failure=https%3A%2F%2Faccount.my.com%2Fsocial_back%2F%3Fsoc_error%3D1%26continue%3Dhttps%253A%252F%252Faccount.my.com%252Fprofile%252Fuserinfo%252F">
            <img src="//account.my.com/img/common/oauth_steam.png">
        </a>
        <a class="js_social_login" data-soc="ps" href="https://auth-ac.my.com/social/ps?continue=https%3A%2F%2Faccount.my.com%2Fsocial_back%2F%3Fcontinue%3Dhttps%253A%252F%252Faccount.my.com%252Fprofile%252Fuserinfo%252F&failure=https%3A%2F%2Faccount.my.com%2Fsocial_back%2F%3Fsoc_error%3D1%26continue%3Dhttps%253A%252F%252Faccount.my.com%252Fprofile%252Fuserinfo%252F">
            <img src="//account.my.com/img/common/oauth_ps.png">
        </a>

                        </div>
                    </li>
                </ul>
                <input type="hidden" name="continue" value="https://account.my.com/login_continue/?continue=https%3A%2F%2Faccount.my.com%2Fprofile%2Fuserinfo%2F">
                <input type="hidden" name="failure" value="https://account.my.com/login/?continue=https%3A%2F%2Faccount.my.com%2Fprofile%2Fuserinfo%2F">
                <input type="hidden" name="nosavelogin" value="0">
            </div>
        </form>
    </div>
</div>
    ...
    <div class="mcTRow mcTRow_footer">
...
<script type="text/x-template" id="tmplFooter">
 ...
 _gaq.push(['_setDomainName', 'my.com']);
  ...
  (function() {
    ...
    <script src="//account.my.com/build/js/accounts/accounts.js?v=20201030.1554-175"></script>
</body>
</html>
```