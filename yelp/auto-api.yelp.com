```<!doctype html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://s3-media0.fl.yelpcdn.com/assets/srv0/developer_pages/2641845f0384/assets/scss/developers-pkg.css">
    ...
    Yelp Developers
        ...
        <script>
            (function() {
                ...
                main({"clientID": "76D9D479F811EF42", "dimensions": {"www": {"account_level": [1, null], "full_url": [34, "/developers"], "internal_ip": [27, false], "referrer": [64, "none"]}, "global": {"account_level": [1, null], "full_url": [15, "/developers"], "internal_ip": [18, false], "referrer": [28, "none"]}}, "domain": "yelp.com", "enable_high_volume_events": false, "ga_enabled": true, "js_dimensions": {"www": {}, "global": {}}, "metrics": {"www": {}, "global": {}}, "trackers": {"www": "UA-30501-24", "global": "UA-30501-1"}, "user_id": null},null);
            })();
    </script>
...
<noscript>
    ...
    <div class="y-container y-container u-bg-slate-extra-light u-text-alpha y-container--space-6 landing-head">
        ...
        <span aria-hidden="true" data-share-url="https://www.facebook.com/sharer/sharer.php?u=yelp.com/developers&amp;quote=Build%20with%20Yelp%20yelp.com/developers" data-social-media="facebook" style="width: 24px; height: 24px;" class="icon icon--24-facebook icon--size-24 js-share-button">
    <svg role="img" class="icon_svg">
        ...
        <span aria-hidden="true" data-share-url="https://twitter.com/home?status=Build%20with%20Yelp%20yelp.com/developers" data-social-media="twitter" style="width: 24px; height: 24px;" class="icon icon--24-twitter icon--size-24 js-share-button">
    <svg role="img" class="icon_svg">
        ...
        <span aria-hidden="true" data-share-url="https://mobile.twitter.com/home?status=Build%20with%20Yelp%20yelp.com/developers" data-social-media="twitter" style="width: 24px; height: 24px;" class="icon icon--24-twitter icon--size-24 js-share-button">
    <svg role="img" class="icon_svg">
        <use xlink:href="#24x24_twitter" />
    </svg>
</span>
        ...
        <span aria-hidden="true" data-share-url="https://www.linkedin.com/shareArticle?mini=true&amp;url=yelp.com/developers&amp;title=Yelp%20Developers%20-%20Build%20with%20Yelp&amp;summary=Build%20with%20Yelp" data-social-media="linkedin" style="width: 24px; height: 24px;" class="icon icon--24-linkedin icon--size-24 js-share-button">
    <svg role="img" class="icon_svg">
