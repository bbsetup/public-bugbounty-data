...
<meta name="csrf-token" content="GD9pkGtNaQ7rUiL3rUL3DHh9TNmNt6oY/k5fvRInMugqFaJZ0gYYIBathqEKMab07dieVF2SU2u7oplqgzsceQ==" />
...
<body>
  ...
  <div class="headline center">
      <h1>Harvest ID</h1>
      <p class="close">Sign in to a <strong>Harvest</strong> or <strong>Forecast</strong> account</p>
  </div>

  <a class="button button-big button-full button-gapps" href="/google/oauth2/new?state%5Bintent%5D=sign-in">
    Sign In with Google
</a>
  <div class="or-break">
    <span>or</span>
  ...
  <form action="/sessions" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="MY4G7vF6l3tDUdCn0a8Bk7zP5P3oMHIoczx7yaBMPBkeza2yfk/MZ7nyFI3ijY0LcdwiVqqoR2b+oNc36trrnQ==" />
    <div class="field">
