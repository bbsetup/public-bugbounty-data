...
<meta name="csrf-token" content="tMC41UcNPF9FRbizxGEmkuWK6c/Li8dv3OlkpVqQMFDo+R0zK/1SpeRdsLUWVEfgdOrbrfX78EJeIFBlg/MKLQ==" />
...
<body>
  ...
  <div class="headline center">
        ...
        <h1>74 Marketing, Inc.</h1>
  </div>

  <a class="button button-big button-full button-gapps" href="/google/oauth2/new?state%5Baccount_id%5D=129786&amp;state%5Bintent%5D=sign-in">
    Sign In with Google
</a>
  <div class="or-break">
    <span>or</span>
  ...
  <form action="/sessions" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="L0EmB3FshlV3lG7zdUnxQjcRT7QDK2VcOn/lAefDaSgiI2REwAf/dvgfWOKBt0fiVw/xNb3EM6EYCgkPGdhXmA==" />
    <div class="field">
    ...
    <div class="field">
      ...
      <input type="hidden" name="account_id" id="account_id" value="129786" />
