...
<meta name="csrf-token" content="Mb4rXC5zGBNEV2WKQkD/rRBpxuI2favqTY3cuQox5yVJPn7kccsZGrv8wHPt9BmBOjXFJIoIjhbEMKmOO4RmQg==" />
...
<body>
  ...
  <div class="headline center">
        ...
        <h1>Epitomics - an Abcam Company</h1>
  </div>

  <a class="button button-big button-full button-gapps" href="/google/oauth2/new?state%5Baccount_id%5D=330389&amp;state%5Bintent%5D=sign-in&amp;state%5Breturn_to%5D=%2Fcompany%2Fonhold%2Freactivate">
    Sign In with Google
</a>
  <div class="or-break">
    <span>or</span>
  ...
  <form action="/sessions" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="R7kFIE6ATLgjviKqYWCRgk9LSnEZp7BjHnShBsa5fZTgAQdLAV214V9MRQ6uJwoe7OQJ71jXa+hioL3uFZ+rGg==" />
    <div class="field">
    ...
    <div class="field">
      ...
      <input type="hidden" name="account_id" id="account_id" value="330389" />
      <input type="hidden" name="return_to" id="return_to" value="/company/onhold/reactivate" />
