...
<div class="netflix-authentication__content-wrapper">
  <div class="netflix-authentication__container">
    <form method="POST" action="/as/d7SR1/resume/as/authorization.ping" autocomplete="off">
      <div>
        ...
        <div class="netflix-authentication__container__actions fixed-width-buttons">
            ...
            <form accept-charset="UTF-8" action="/as/d7SR1/resume/as/authorization.ping?ChangePassword=true" autocomplete="off" class="netflix-authentication-section__block ng-pristine ng-valid" method="get"><div class="ie-button ie-button-gray"><input type="submit" class="netflix-button netflix-button--gray netflix-button--small" value="Forgot password" /></div></form>
            <a id="post-ok" href="javascript:void(0)" class="netflix-button netflix-button--red netflix-button--small"><span>Partner Sign in</span></a><a class="netflix-button netflix-button--gray netflix-button--small" href="/as/d7SR1/resume/as/authorization.ping?ChangePassword=true"><span>Forgot password</span></a>
        </div>
...
<script type="text/javascript">
  ...
  if (window != top) {
    ...
    var target = "/ext/pwdreset/Identify?AdapterId=nflxPartnerDirectoryLogin&TargetResource=https%3A%2F%2Fmeechum.netflix.com%2Fas%2Fd7SR1%2Fresume%2Fas%2Fauthorization.ping";
  ...
  function postCancel() {
    ...
    document.forms[0].action = '/as/d7SR1/resume/as/authorization.ping?nextAdapter=True';
