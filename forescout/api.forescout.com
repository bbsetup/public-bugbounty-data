...
<title>api.forescout.com | 522: Connection timed out</title>
<meta charset="UTF-8" />
...
<div id="cf-wrapper">
    ...
    <div id="cf-error-details" class="p-0">
        <header class="mx-auto pt-10 lg:pt-6 lg:px-8 w-240 lg:w-full mb-8">
            ...
            <span class="inline-block sm:block font-mono text-15 lg:text-sm lg:leading-relaxed">Ray ID: 615fdd3a88ac0ce5 &bull;</span>
            <span class="inline-block sm:block font-mono text-15 lg:text-sm lg:leading-relaxed">2021-01-23 07:41:02 UTC</span>
...
<div id="cf-host-status" class="cf-error-source relative w-1/3 md:w-full py-15 md:p-0 md:py-8 md:text-left md:border-solid md:border-0 md:border-b md:border-gray-400 overflow-hidden float-left md:float-none text-center">
  ...
  <span class="md:block w-full truncate">api.forescout.com</span>
  ...
  <p class="text-13">
    <span class="cf-footer-item sm:block sm:mb-1">Cloudflare Ray ID: <strong class="font-semibold">615fdd3a88ac0ce5</strong></span>
