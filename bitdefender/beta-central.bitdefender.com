...
<head>   
    ...
    <!-- Hotjar Tracking Code for central.bitdefender.com -->
        ...
        <link rel="stylesheet" type="text/css" href="v1/assets/Central-3.21.1008-1784a36.css" />
        
            <!-- compiled JavaScript -->
            
                <script type="text/javascript" src="v1/assets/localization/Central-locale-3.21.1008-1784a36.js"></script>
                
                <script type="text/javascript" src="v1/assets/Central-3.21.1008-1784a36.js"></script>
                

    <script>
        Raven
            .config('https://715e152367724ce8be0b0dcd8afbc88e@catch-nimbus.bitdefender.net/16',{
release: "3.21.1008-1784a36"
            })
...
<span class="version">v3.21.1008-1784a36</span>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="user_menu_container" id="user_menu">
        <div class="sidebar" ng-class="{'slide' : addclassSlideUser}">
            ...
            <ul class="flex-list">   
                ...
                <li>
                    <a ng-click="clearMenus(); forceRefreshOnPath('/account/settings')" href="" class="flex-list-item">
                            <i class="connect_icon_settings mr-2"></i>
