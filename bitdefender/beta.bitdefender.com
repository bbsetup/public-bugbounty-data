...
<script type="text/javascript" src="//www.bitdefender.com/site/Main/generalDigitalData/?p=us:main:showhomepage&dl=en&t=&h=ip-10-122-2-52.ec2.internal&s=www.bitdefender.com"></script>
...
<section class="solutions" id="Solutions">
    <div class="container">
        <div class="row row--custom-spacing">
            ...
            <div class="col-lg-3 col-sm-6 col-12 d-flex">
                <div class="solutions__item d-flex flex-sm-column flex-row">
                    <a class="solutions__name__link__mobile d-block d-sm-none" href="//www.bitdefender.com/partners/" onClick="s_objectID='Partners';"></a>
                    <div class="solutions__icon-container d-flex align-items-sm-end justify-content-center">
                    ...
                    <div class="solutions__info-container d-flex flex-column">
                        <h2 class="solutions__name"><a class="solutions__name__link" href="//www.bitdefender.com/partners/" onClick="s_objectID='Partners';">Partners</a></h2>
                        <h3 class="solutions__text">Want to integrate, build, package or resell? Get powered by Bitdefender today.</h3>
                        <div class="solutions__button-container">
                            <a class="button-1 d-sm-inline-block d-none" href="//www.bitdefender.com/partners/" onClick="s_objectID='Partners';">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="awards">
    ...
    <div class="row">
        <div class="col-lg-6 col-12 d-flex justify-content-md-between justify-content-around align-items-center pr-lg-0">
            <a href="https://www.av-comparatives.org/tests/summary-report-2020/" target="_blank">
            <img style="max-width: 90px;" alt="Award - AV Comparatives 2020" class="awards__img-1 awards__img lazy" data-src="https://download.bitdefender.com/resources/themes/draco/images/lite_v2/awards/av2021.png"
                 data-srcset="https://download.bitdefender.com/resources/themes/draco/images/lite_v2/awards/av2021_2x.png 2x"/>
            </a>
...
<section class="statement" id="Statement">
    ...
    <script type="text/javascript"
        ...
        <link rel="stylesheet"
          href="https://download.bitdefender.com/resources/themes/draco/minimize/lite_v2/csslite_v2.v772.min.css"
          type="text/css"/>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.5.0/css/swiper.min.css">


        <script type="text/javascript"
            src="https://download.bitdefender.com/resources/themes/draco/minimize/lite_v2/jslite_v2.v868.min.js"></script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam-cell.nr-data.net","licenseKey":"86f61f5b73","applicationID":"77412376","transactionName":"ZQBTZUpQWRcDVRdYWFxKckRLRVgJTXsCWFkdFlleT3xWDQwZ","queueTime":0,"applicationTime":77,"atts":"SUdQEwJKShk=","errorBeacon":"bam-cell.nr-data.net","agent":""}</script></body>
</html>
```