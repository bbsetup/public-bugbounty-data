...
<script type="text/javascript" src="//www.bitdefender.com/site/Main/generalDigitalData/?p=us:main:showhomepage&dl=en&t=&h=ip-10-122-2-61.ec2.internal&s=www.bitdefender.com"></script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam-cell.nr-data.net","licenseKey":"86f61f5b73","applicationID":"77412376","transactionName":"ZQBTZUpQWRcDVRdYWFxKckRLRVgJTXsCWFkdFlleT3xWDQwZ","queueTime":0,"applicationTime":58,"atts":"SUdQEwJKShk=","errorBeacon":"bam-cell.nr-data.net","agent":""}</script></body>
</html>
```