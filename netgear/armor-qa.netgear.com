...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/Central-2.18.302-5305a13.css" />
    
    <link id="orbi" rel="stylesheet" type="text/css" ng-href="{{orbicss}}" />
    <!-- compiled JavaScript -->
    
    <script type="text/javascript" src="assets/localization/Central-locale-2.18.302-5305a13.js"></script>
    
    <script type="text/javascript" src="assets/Central-2.18.302-5305a13.js"></script>
...
<span id="about_version">v2.18.302-5305a13</span>
