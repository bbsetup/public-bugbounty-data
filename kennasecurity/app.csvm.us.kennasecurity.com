...
<meta name="csrf-token" content="hEFI/SfC7kXEjppnVfy4yyyAHf/PDJeSiXyBwR+nV4FOmRpWnYsjrClN/jfu/o+wVbM6Or3+TRUjbYTGnTQZKw==" />
...
<form class="new_user" id="new_user_session" role="form" action="/users/sign_in" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="h++RAO2q8aZSczKKLp5hPW63zYxblwOZe3PKvLuTFplNN8OrV+M8T7+wVtqVnFZGF4TqSSll2R7RYs+7OQBYMw==" />
