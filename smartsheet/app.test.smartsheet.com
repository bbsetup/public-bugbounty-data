...
<head>
	...
	<link rel='icon' href='/b/images/fav_test.png' type='image/png' /><link rel='shortcut icon' href='/b/images/fav_test.png' type='image/png' />
    <link rel="stylesheet" type="text/css" id="smartsheet_style_fonts" href="https://app.test.smartsheet.com/b/css/fonts.2x_116.0.2.css"/>
	<link rel="stylesheet" type="text/css" id="smartsheet_style_login" href="https://app.test.smartsheet.com/b/css/login.2x_116.0.2.css"/>

	<script type="text/javascript" language="JavaScript" CHARSET="UTF-8">var clientState={"Xit":"116.0","cbi":"2","version":"116.0.2","baseImageUrl":"https://s.test.smartsheet.com/b"};</script><script type="text/javascript" language="JavaScript" CHARSET="UTF-8" src="https://app.test.smartsheet.com/b/javascript/core_116.0.2.js"></script><script type="text/javascript" language="JavaScript" CHARSET="UTF-8" src="https://app.test.smartsheet.com/b/javascript/login_116.0.2.js"></script>
	<link rel="apple-touch-icon" sizes="57x57" href="https://s.test.smartsheet.com/b/images/img_icon-57x57.png" /><link rel="apple-touch-icon" sizes="76x76" href="https://s.test.smartsheet.com/b/images/img_icon-76x76.png" /><link rel="apple-touch-icon" sizes="120x120" href="https://s.test.smartsheet.com/b/images/img_icon-120x120.png" /><link rel="apple-touch-icon" sizes="152x152" href="https://s.test.smartsheet.com/b/images/img_icon-152x152.png" /><link rel="apple-touch-icon" sizes="167x167" href="https://s.test.smartsheet.com/b/images/img_icon-167x167.png" /><link rel="apple-touch-icon" sizes="180x180" href="https://s.test.smartsheet.com/b/images/img_icon-180x180.png" /><link rel="shortcut icon" sizes="128x128" href="https://s.test.smartsheet.com/b/images/img_icon-128x128.png" /><link rel="shortcut icon" sizes="196x196" href="https://s.test.smartsheet.com/b/images/img_icon-196x196.png" />
...
<table style="position:absolute; width:100%; height:100%; border: 0px none; border-collapse:collapse;">
	<tr>
		...
		<td class="clsGlobalLayoutContentCell">
			<form action="home?ss_v=116.0.2"  id="ctlForm"  name="ctlForm"  method="post"  class="clsJspOuterForm" novalidate="novalidate">
			<div class="clsJspFormLogo" id="divFormTitleImage" name="divFormTitleImage" style="text-align: center; width: 100%; "><img src="https://app.test.smartsheet.com/b/images/smartsheet-logo-light-text.svg"></div>
	...
	<tr>
		...
		<td onmouseover="showTooltips(this, &quot;Log in with your Apple account.&quot;)" onmouseout="hideTooltips()">
			<a id="authLink"
			   ...
			   href="https://app.test.smartsheet.com/b/applelogin?formName=fn_applelogin&amp;formAction=fa_loginApple&amp;sua=home"
			   ...
			   class="clsLoginMethodButton">
				...
				<div>
					<img id="applelogo" width="15px" src="https://s.test.smartsheet.com/b/images/img_login_apple.2x.png" alt="Apple"/>
					<span>Apple</span>
				</div>
			</a>
		</td>
...
<div class="clsJspFormFooter">
	<table>
		<tr>
			<td><a href="https://app.test.smartsheet.com/b/signup" onClick="delayedLinkWithFunction(event,this,function () {logExternalGTMEvent({'event': 'non-application-event', 'eventObject': 'login screen','object-noun': 'Form - Login','object-string': 'Signup','object-type': 'link','object-verb': 'Click'})},100);" >Don't have a login? Sign up.</a></td>
		</tr>
	</table>
</div>
...
frame.src = 'https://s.test.smartsheet.com/b/htmlSandbox/gtm-iframe_v2.html?' + encodeURIComponent(location.protocol + '//' + location.host) + '&GTM-5GPPFG&eventObject=login screen&eventNoun=Form - Login';
