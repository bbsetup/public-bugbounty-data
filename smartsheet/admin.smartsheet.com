...
<table style="position:absolute; width:100%; height:100%; border: 0px none; border-collapse:collapse;">
	<tr>
		...
		<td class="clsGlobalLayoutContentCell">
			...
			<div class="clsJspFormHeader" id="divFormTitleBar" name="divFormTitleBar" data-client-id="form-title" style="text-align: center; width: 100%; ">Log in to access Admin Center.</div>
	...
	<tr>
		...
		<td onmouseover="showTooltips(this, &quot;Log in with your Apple account.&quot;)" onmouseout="hideTooltips()">
			<a id="authLink"
			   ...
			   href="https://app.smartsheet.com/b/applelogin?formName=fn_applelogin&amp;formAction=fa_loginApple&amp;lgt=ac&amp;lrsp=%2F&amp;sua=home"
...
<div class="clsJspFormFooter">
	<table>
		<tr>
			<td><a href="https://app.smartsheet.com/b/signup?lrsp=%2F&amp;lgt=ac" onClick="delayedLinkWithFunction(event,this,function () {logExternalGTMEvent({'event': 'non-application-event', 'eventObject': 'login screen','object-noun': 'Form - Login','object-string': 'Signup','object-type': 'link','object-verb': 'Click'})},100);" >Don't have a login? Sign up.</a></td>
		</tr>
	</table>
</div>
