...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <p>
        Did you mean to visit <a href="//10.github.io/">10.github.io</a>?
        Please note that this site belongs to a GitHub user and is
        <strong>not an official GitHub site</strong>.
      </p>

      <p>
        If you're the owner of this site, please update your links to use <code>10.github.io</code> instead.
