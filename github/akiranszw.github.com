    ...
    <div class="container">
      ...
      <div id="logo">
        <a href="/">
          ...
          <div id="claim">
            あなたが葛飾区に納めた税金がどこで使われているかをお示しします
          </div>
        </a>
      </div>
      <nav>
...
<div id="dailybread">
  ...
  <footer>
    <div class="inner">
      <div class="container">
        <p>
          Where Does My Money Go? (日本語版 ver.1.0.) は、イギリスの Open Knowledge Foundation が開発した Where Does My Money Go? (英語版) をベースに開発されています。使われているデータは葛飾区の平成25年度一般会計予算の款・項ごとの歳出予算額です。Where Does My Money Go? プロジェクトは、公共データのオープン化を進める有志に支えられています。</p>
