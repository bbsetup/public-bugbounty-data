...
<head id="ctl00_ctl00_Head1"><title>
	jbrodriguez.io - Registered at Namecheap.com
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUENTM4MWRkJCMHCLsumIpWJhu0Y3JcjsxevbVp7Q+kfPpJNrR9lvI=" />
		...
		<div id="holder">
				<div id="header">
					<div class="width">
						...
						<h1 id="domaintitle"><a href="#">jbrodriguez.io</a></h1>
					</div>
				</div><!--header-->
