...
<head id="ctl00_ctl00_Head1"><title>
	angelovargas.com - Registered at Namecheap.com
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUENTM4MWRkC8Tx+JX8MRRaE8+l70tPThBpnwfI7S3XLL1KX7TNDHA=" />
		...
		<div id="holder">
				<div id="header">
					<div class="width">
						...
						<h1 id="domaintitle"><a href="#">angelovargas.com</a></h1>
					</div>
				</div><!--header-->
