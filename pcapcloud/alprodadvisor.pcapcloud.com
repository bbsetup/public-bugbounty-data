...
<title>alprodadvisor.pcapcloud.com | 526: Invalid SSL certificate</title>
<meta charset="UTF-8" />
    ...
    <div id="cf-error-details" class="p-0">
        <header class="mx-auto pt-10 lg:pt-6 lg:px-8 w-240 lg:w-full mb-8">
            <h1 class="inline-block sm:block sm:mb-2 font-light text-60 lg:text-4xl text-black-dark leading-tight mr-2">
              ...
              <span class="cf-error-code">526</span>
            </h1>
            <span class="inline-block sm:block font-mono text-15 lg:text-sm lg:leading-relaxed">Ray ID: 615e23f8ce0fccee &bull;</span>
            <span class="inline-block sm:block font-mono text-15 lg:text-sm lg:leading-relaxed">2021-01-23 02:38:47 UTC</span>
            <h2 class="text-gray-600 leading-1.3 text-3xl font-light">Invalid SSL certificate</h2>
        </header>
...
<div id="cf-host-status" class="cf-error-source relative w-1/3 md:w-full py-15 md:p-0 md:py-8 md:text-left md:border-solid md:border-0 md:border-b md:border-gray-400 overflow-hidden float-left md:float-none text-center">
  ...
  <span class="md:block w-full truncate">alprodadvisor.pcapcloud.com</span>
  ...
  <p class="text-13">
    <span class="cf-footer-item sm:block sm:mb-1">Cloudflare Ray ID: <strong class="font-semibold">615e23f8ce0fccee</strong></span>
