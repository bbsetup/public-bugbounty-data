...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;oauth2&#x2f;v1&#x2f;authorize&#x2f;redirect&#x3f;okta_key&#x3d;Wk9xIhvtfWq77ixM9EQHeOxnrRbvwdCQWIVtYkejJXM"/>
</form>
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Foath.okta.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Foauth2\x2Fv1\x2Fauthorize\x2Fredirect\x3Fokta_key\x3DWk9xIhvtfWq77ixM9EQHeOxnrRbvwdCQWIVtYkejJXM';
  var username = '';
  var rememberMe = true;
  var smsRecovery = true;
  var callRecovery = false;
  var emailRecovery = true;
  var usernameLabel = 'Username\x20\x2F\x20ShortID';
  var usernameInlineLabel = '';
  var passwordLabel = 'Password';
  var passwordInlineLabel = '';
  var signinLabel = 'Sign\x20In';
  var forgotpasswordLabel = 'Forgot\x20Password\x3F\x20Contact\x20the\x20GSD\x20or\x20self\x20reset\x20in\x20Slack.';
  var unlockaccountLabel = 'Account\x20Locked\x3F\x20Contact\x20the\x20GSD\x20or\x20self\x20unlock\x20in\x20Slack.';
  var helpLabel = 'Help';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://ok4static.oktacdn.com/fs/bco/1/fs0aexo9ulphugpe21t7',
      logoText: 'Oath\x3A logo',
      ...
      helpLinks: {
        help: '',
        forgotPassword: 'https\x3A\x2F\x2Fslack.com\x2Fapp_redirect\x3Fapp\x3DAD8BYTHJB',
        unlock: 'https\x3A\x2F\x2Fslack.com\x2Fapp_redirect\x3Fapp\x3DAD8BYTHJB',
        custom: customLinks
      }
    }
  };
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://ok4static.oktacdn.com/fs/bco/7/fs0gx4nbx695Q28581t7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://ok4static.oktacdn.com/fs/bco/7/fs0gx4nbx695Q28581t7', sizingMethod='scale')");
  });
</script>
