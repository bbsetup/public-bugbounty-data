...
<html lang="en-us">
  ...
  <!-- status code : 502 -->
  <!-- Unknown Host -->
  <!-- host machine: media-router-omega7028.prod.media.gq1.yahoo.com -->
  <!-- timestamp: 1611338756.803 -->
  <!-- url: http://3p-pclick.internal.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '502',
        test: '-',
        ats_host: 'media-router-omega7028.prod.media.gq1.yahoo.com',
        rid: '-',
