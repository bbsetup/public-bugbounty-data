...
<html lang="en-us">
  ...
  <!-- host machine: media-router-api7013.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1611386518.412 -->
  <!-- url: https://api.cricket.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '404',
        test: '-',
        ats_host: 'media-router-api7013.prod.media.bf1.yahoo.com',
        rid: '-',
