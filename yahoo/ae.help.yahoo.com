...
<html lang="en-us">
  ...
  <!-- host machine: media-router-ui7034.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1611353894.890 -->
  <!-- url: https://ae.help.yahoo.com/kb/account-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '404',
        test: '-',
        ats_host: 'media-router-ui7034.prod.media.bf1.yahoo.com',
        rid: '-',
