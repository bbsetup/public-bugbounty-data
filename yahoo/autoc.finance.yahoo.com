...
<html lang="en-us">
  ...
  <!-- host machine: media-router-ui7030.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1611744818.335 -->
  <!-- url: https://autoc.finance.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '404',
        test: '-',
        ats_host: 'media-router-ui7030.prod.media.bf1.yahoo.com',
        rid: '-',
