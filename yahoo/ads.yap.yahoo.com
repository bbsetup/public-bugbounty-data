...
<html lang="en-us">
  ...
  <!-- host machine: media-router-flurry7020.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1611353338.435 -->
  <!-- url: https://ads.yap.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '404',
        test: '-',
        ats_host: 'media-router-flurry7020.prod.media.bf1.yahoo.com',
        rid: '-',
