...
<html lang="en-us">
  ...
  <!-- status code : 502 -->
  <!-- Unknown Host -->
  <!-- host machine: media-router-omega7107.prod.media.gq1.yahoo.com -->
  <!-- timestamp: 1611743517.013 -->
  <!-- url: https://aud-gca.production.omega.gq1.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '502',
        test: '-',
        ats_host: 'media-router-omega7107.prod.media.gq1.yahoo.com',
        rid: '-',
