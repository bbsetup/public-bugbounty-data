...
<html lang="en-us">
  ...
  <!-- host machine: media-router-ui7043.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1611375759.568 -->
  <!-- url: https://amp.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '404',
        test: '-',
        ats_host: 'media-router-ui7043.prod.media.bf1.yahoo.com',
        rid: '-',
