...
<html lang="en-us">
  ...
  <!-- status code : 502 -->
  <!-- Could Not Connect -->
  <!-- host machine: media-router-brb7081.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1611339080.396 -->
  <!-- url: https://3p-ews.hl.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '502',
        test: '-',
        ats_host: 'media-router-brb7081.prod.media.bf1.yahoo.com',
        rid: '-',
