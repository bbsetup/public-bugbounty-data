...
<html lang="en-us">
  ...
  <!-- host machine: media-router-ui7001.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1613026954.393 -->
  <!-- url: https://barcelona.research.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '404',
        test: '-',
        ats_host: 'media-router-ui7001.prod.media.bf1.yahoo.com',
        rid: '-',
