...
<html lang="en-us">
  ...
  <!-- host machine: media-router-api7038.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1611387968.209 -->
  <!-- url: https://api.sports.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '404',
        test: '-',
        ats_host: 'media-router-api7038.prod.media.bf1.yahoo.com',
        rid: '-',
