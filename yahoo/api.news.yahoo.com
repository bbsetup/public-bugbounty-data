...
<html lang="en-us">
  ...
  <!-- host machine: media-router-api7021.prod.media.bf1.yahoo.com -->
  <!-- timestamp: 1611387570.066 -->
  <!-- url: https://api.news.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '404',
        test: '-',
        ats_host: 'media-router-api7021.prod.media.bf1.yahoo.com',
        rid: '-',
