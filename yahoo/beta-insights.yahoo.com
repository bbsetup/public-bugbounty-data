...
<html lang="en-us">
  ...
  <!-- status code : 502 -->
  <!-- Unknown Host -->
  <!-- host machine: media-router-omega7005.prod.media.gq1.yahoo.com -->
  <!-- timestamp: 1613033330.386 -->
  <!-- url: https://beta-insights.yahoo.com/-->
  <script type="text/javascript">
    ...
    var params = {
        ...
        err: '502',
        test: '-',
        ats_host: 'media-router-omega7005.prod.media.gq1.yahoo.com',
        rid: '-',
