...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;oauth2&#x2f;v1&#x2f;authorize&#x2f;redirect&#x3f;okta_key&#x3d;Ha0T-_UghoIwlIGdpWyjkH73zwCYkEUP8jFCF-YmdIs"/>
</form>
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fsegment.okta.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Foauth2\x2Fv1\x2Fauthorize\x2Fredirect\x3Fokta_key\x3DHa0T\x2D_UghoIwlIGdpWyjkH73zwCYkEUP8jFCF\x2DYmdIs';
  var username = '';
  var rememberMe = true;
  ...
  var signinLabel = 'Sign\x20In\x20to\x20Segment\x20with\x20Okta';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://ok4static.oktacdn.com/fs/bco/1/fs0g708h532PMc4AP1t7',
      logoText: 'Segment logo',
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://ok4static.oktacdn.com/fs/bco/7/fs0e5gzrom4mJCDTv1t7')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://ok4static.oktacdn.com/fs/bco/7/fs0e5gzrom4mJCDTv1t7', sizingMethod='scale')");
  });
</script>
