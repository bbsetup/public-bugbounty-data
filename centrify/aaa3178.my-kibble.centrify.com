...
<head>
    ...
    <script type="text/javascript">
        ...
        * ASP.NET context.
        */
        var AuthData = {"TenantConfig":{"PortalImage":null,"WelcomeMessage":"This welcome text and logo can be configured by visiting https://kibble.centrify.com/admin.aspx.","ForgotUsernameAllowed":false,"LoginImage":null},"KnownTenant":true,"Authenticated":false};
