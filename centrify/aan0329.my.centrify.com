    ...
    <script type="text/javascript">
            ...
            window.onload = function() {
                ...
                if (areCookiesEnabled()) {
                    ...
                    var iwaInfos = JSON.parse('[{"CheckServiceTimeout":10000,"InternalCheckURL":"https://LPSDC2K8VM1:8443/iwa/GetOneTimePass","InternalProxyURL":"https://LPSDC2K8VM1:8443/iwa/","IwaVersion":"3.0","UseAjaxCors":true}]');
                    var index = 0;
