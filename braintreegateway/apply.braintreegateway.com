...
<html>
  <head>
    ...
    <meta property="og:url" content="https://apply.braintreegateway.com/country/usa">
...
<meta name="csrf-token" content="ks7FRAKpyTpMfMecrmeeZ5N8NrskhNzXa8c2r5HtNDxIVQMGkux0kWeXLGa3rjvczXp4oybNl5ca6/WmxrF/OQ==" />
  </head>
  <body>
    <noscript>
      <img src="https://api.mixpanel.com/track/?data=eyJldmVudCI6Im5vc2NyaXB0IiwicHJvcGVydGllcyI6eyJhcHAiOiJBcHBs
eSIsInRpbWUiOjE2MTEzOTEyNjAsInRva2VuIjoiNTM5ZjQxMzJmZWM4NWNl
MzQ2YjZmN2Y5OWNiNzYxNGUiLCIkY3VycmVudF91cmwiOiJodHRwczovL2Fw
cGx5LmJyYWludHJlZWdhdGV3YXkuY29tL2NvdW50cnkvdXNhIn19
&img=1">
      <style>
  .ev-main {
...
<div class="ev-main">
  ...
  <div class="ev-content">
    ...
    <script src="/packs/signups-321da3d1c210aa1aa4fd.js"></script>
...
<!-- Double Click -->
  <script>
    ...
    document.write('<iframe src="https://fls.doubleclick.net/activityi;src=3656429;type=cpeap707;cat=signu070;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
  </script>
  <noscript>
    <iframe src="https://fls.doubleclick.net/activityi;src=3656429;type=cpeap707;cat=signu070;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
  </noscript>
<!-- End Double Click -->
