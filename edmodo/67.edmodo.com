...
<head profile="http://www.w3.org/2005/10/profile">
    ...
    <title>
        Connect With Students and Parents in Your Paperless Classroom | Edmodo    </title>
...
<meta property="og:url" content="https://67.edmodo.com/" />
...
<meta name="twitter:site" content="@edmodo" />
    ...
    <meta property="og:description" content="Edmodo is an easy way to get your students connected so they can safely collaborate, get and stay organized, and access assignments, grades, and school messages." />
...
<body class="epage-index  rippers lp7 jglp windows" data-is-apps-sandbox="0">

            <script>
  window.location = 'https://' + 'new.edmodo.com/' + '?go2url=%2Fhome' ;
</script>
<script>
...
<script>
            try {
        modo.common.growth.set('abtests', {"subdomain_ldap_gatekeeper":"CONTROL","Activity_Review_Test":"CONTROL","facebook_sso":"CONTROL","student_signup_page_test":"enabled","landing_page_react":"enabled","world_teachers_day_lp":"enabled","register_by_phone_for_students_rollout":"CONTROL","growth_dummy_test":"CONTROL","growth_dummy_test_grow2_429":"variant_2","account_recovery_react":"enabled"});
        modo.common.growth.set('ab_three_col', true);
        modo.common.growth.set('landing_page', "1");
