...
<head>
    ...
    <title>GitHub, Inc. - Prod - Sign In</title>
        <meta charset="UTF-8">
...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;app&#x2f;githubincprod_oktanetworkgatewayairflowstaginggithubappcom_1&#x2f;exk1e4kmk3zIdmO561d8&#x2f;sso&#x2f;saml&#x3f;RelayState&#x3d;a6462ac9-01ee-4cac-bc4a-335a92b8ebf6"/>
</form>
          ...
          <div class="applogin-container">
              <h1>
                Connecting to<div class="applogin-app-logo">
                      <img src="https://ok3static.oktacdn.com/assets/img/logos/default.6770228fb0dab49a1695ef440a5279bb.png" alt="Okta&#x20;Network&#x20;Gateway&#x20;&#x28;airflow-staging.githubapp.com&#x29;" class="logo githubincprod_oktanetworkgatewayairflowstaginggithubappcom_1"/></div>
              </h1>
              <p>Sign-in with your GitHub, Inc. - Prod account to access Okta Network Gateway (airflow-staging.githubapp.com)</p>
          </div>
      </div>
  <style type="text/css">
    .noscript-msg {
...
(function(){
  ...
  var baseUrl = 'https\x3A\x2F\x2Fgithub.okta.com';
  var suppliedRedirectUri = '';
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Fapp\x2Fgithubincprod_oktanetworkgatewayairflowstaginggithubappcom_1\x2Fexk1e4kmk3zIdmO561d8\x2Fsso\x2Fsaml\x3FRelayState\x3Da6462ac9\x2D01ee\x2D4cac\x2Dbc4a\x2D335a92b8ebf6';
  var username = '';
  var rememberMe = true;
  ...
  var usernameInlineLabel = 'github\x2Dusername\x40github.com';
  var passwordLabel = 'Password';
  var passwordInlineLabel = 'Your\x20github.com\x20account\x20password';
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      baseUrl: baseUrl,
      brandName: 'Okta',
      logo: 'https://ok3static.oktacdn.com/fs/bco/1/fs0wdsnbfaZTVZLPDBHR',
      logoText: 'GitHub,\x20Inc.\x20\x2D\x20Prod logo',
      ...
      helpLinks: {
        help: '',
        forgotPassword: 'https\x3A\x2F\x2Fgithub.com\x2Fpassword_reset',
        unlock: '',
        custom: customLinks
      }
    }
...
<script>
  window.addEventListener('load', function(event) {
    ...
    applyStyle('login-bg-image', "background-image: url('https://ok3static.oktacdn.com/fs/bco/7/fs017ugso3uAnUjaG1d8')");
    applyStyle('login-bg-image-ie8', "filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://ok3static.oktacdn.com/fs/bco/7/fs017ugso3uAnUjaG1d8', sizingMethod='scale')");
  });
</script>
