...
<head>
    ...
    <script src="https://ok3static.oktacdn.com/assets/js/sdk/okta-signin-widget/5.2.4/js/okta-sign-in.min.js" type="text/javascript"></script>
    <link href="https://ok3static.oktacdn.com/assets/js/sdk/okta-signin-widget/5.2.4/css/okta-sign-in.min.css" type="text/css" rel="stylesheet"/>
...
<form action="/login/cert" method="post" id="x509_login" name="x509_login" style="display:none;">
    <input type="hidden" class="hide" name="_xsrfToken" value="null"/><input type="hidden" id="fromURI" name="fromURI" class="hidden" value="&#x2f;oauth2&#x2f;v1&#x2f;authorize&#x2f;redirect&#x3f;okta_key&#x3d;jhZS0LgnaEurVqwJ14-b1q2yNCZsi7VxHFncwgYbTNw"/>
</form>
...
(function(){
  ...
  var repost = false;
  var stateToken = '';
  var fromUri = '\x2Foauth2\x2Fv1\x2Fauthorize\x2Fredirect\x3Fokta_key\x3DjhZS0LgnaEurVqwJ14\x2Db1q2yNCZsi7VxHFncwgYbTNw';
  var username = '';
  var rememberMe = true;
  ...
  var loginPageConfig = {
    ...
    signIn: {
      ...
      assets: {
        baseUrl: "https\x3A\x2F\x2Fok3static.oktacdn.com\x2Fassets\x2Fjs\x2Fsdk\x2Fokta\x2Dsignin\x2Dwidget\x2F5.2.4"
      },
