...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="canonical" href="https://applause2.magisto.com" />
        ...
        <meta name="apple-mobile-web-app-capable" content="yes">
                ...
                <link rel="shortcut icon" href="https://applause2.magisto.com/media/images/favicon.ico" type="image/vnd.microsoft.icon" />
                <link rel="icon" href="https://applause2.magisto.com/media/images/favicon.ico" type="image/x-icon" />
                <link rel="apple-touch-icon" href="https://applause2.magisto.com/media/images/magisto_ios_icon_large.jpg"/>
    ...
    <meta property="og:url" content="https://applause2.magisto.com"/>



        
    <meta name="twitter:url" content="https://applause2.magisto.com">
    ...
    <meta name="twitter:image" content="https://drrrhyhe9lfip.cloudfront.net/media/images/ogimage150998230369.jpeg">
        ...
        <script>
            ...
            var globals = {
                ...
                is_android          : false,
                is_desktop          : true,
                static_url 			: 'https://applause2.magisto.com/media/',
                sightera_server 	: 'applause2.magisto.com',
                protocol 			: 'https',
                has_https_support 	: true,
                prot_and_server 	: 'https://applause2.magisto.com',
                user_name			: null,
                is_business		 	: false,
                is_tryout           : false,
            ...
            globals.prot_and_server = 'https://applause2.magisto.com';
        ...
        <div class="all_wrap ">
            ...
            <div class="magisto_logo ">
                    ...
                    <a href="/" class="animate" onclick="track_tableau_event('press','header','logo','magisto');">
                            ...
                            <img class="vimeo_magisto_logo hidden_logo" src="https://applause2.magisto.com/media/new/img/logo_magisto_by_vimeo.png" srcset="https://applause2.magisto.com/media/new/img/logo_magisto_by_vimeo@2x.png 2x, https://applause2.magisto.com/media/new/img/logo_magisto_by_vimeo.png 1x"/>
...
@media only screen and (min-width: 960px){
    ...
    <!-- <section class="getty_top_section only_big "  onclick="scrollToItem('.getty_top_section',64)">
        <div class="section_content max_912  pt-xs pb-xs">
            <div class="text-center">
                Now with
                <span class="new_tag">
                    <img height="34" src="//applause2.magisto.com/media//new/img/icons/istock.svg" />
                    <i class="new_flag"></i>
                </span>
    ...
    <div class="section_content pt-xl pb-xl">
        <div class="left_side">
            <div class="image" style="background-image:url('//applause2.magisto.com/media//new/img/banners/green_icons.png');"></div>
        </div>
        <div class="right_side" >
            <h2 class="promo_section_title mb-lg ">60,000 Business video editors</h2>
            <div class="image only_mobile mb-lg" style="background-image:url('//applause2.magisto.com/media//new/img/banners/green_icons.png');"></div>
