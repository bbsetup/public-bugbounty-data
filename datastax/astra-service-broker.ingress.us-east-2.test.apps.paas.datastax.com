     ...
     <div class="container">
        <div class="row">
          <div class="col-12 col-lg-6 col-xl-5">
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="https://auth.cloud.datastax.com/auth/realms/CloudUsers/login-actions/authenticate?session_code=jQsQxJqqteca4UwBHbv67uhJQk5iyILglk0UBk3UbF8&amp;execution=ecfb6266-82a5-4926-b3dc-e64cd5635179&amp;client_id=auth-proxy&amp;tab_id=1lcw9KoUnBY" method="post">
              <h3>Sign In</h3>
              ...
              <div class="form-group row">
                ...
                <div class="col-12 col-md-auto ml-md-auto text-md-right">
                    <a href="/auth/realms/CloudUsers/login-actions/reset-credentials?client_id=auth-proxy&amp;tab_id=1lcw9KoUnBY" class="forgot-password">Forgot Password?</a>
                </div>
              </div>
              ...
              <div id="kc-form-buttons" class="form-group">
               <input tabindex="4" class="btn btn-primary btn-block btn-lg" name="login" id="kc-login" type="submit" value="Sign In"/>
                ...
                <div class="form-group or-separator">
                  ...
                  <div class="form-group">
                    <a class="btn btn-outline-primary btn-block" href="/auth/realms/CloudUsers/broker/github/login?client_id=auth-proxy&amp;tab_id=1lcw9KoUnBY&amp;session_code=jQsQxJqqteca4UwBHbv67uhJQk5iyILglk0UBk3UbF8" id="zocial-github">
                       <img src="/auth/resources/dah2r/login/cloud/img/github-icon.svg" alt="github icon">
                       Sign In with GitHub
                    </a>
                  </div>
                  <div class="form-group">
                    <a class="btn btn-outline-primary btn-block" href="/auth/realms/CloudUsers/broker/google/login?client_id=auth-proxy&amp;tab_id=1lcw9KoUnBY&amp;session_code=jQsQxJqqteca4UwBHbv67uhJQk5iyILglk0UBk3UbF8" id="zocial-google">
