        ...
        <div class="container">
          <nav class="navbar">
            ...
            <p class="ml-auto mb-0">
                ...
                <a href="/auth/realms/CloudUsers/login-actions/registration?client_id=auth-proxy&amp;tab_id=YYrXuyrTcIY">Sign up</a>
            </p>
          </nav>
        </div>
      </header>
     ...
     <div class="container">
        <div class="row">
          <div class="col-12 col-lg-6 col-xl-5">
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="https://non-prod.auth.cloud.datastax.com/auth/realms/CloudUsers/login-actions/authenticate?session_code=KUmGgAlttnh8ew0NxvKAs7t9wE9OxNIL8dgfEhhB7gY&amp;execution=89d7121f-bb88-4bf2-b5a6-3e8ae0499c2d&amp;client_id=auth-proxy&amp;tab_id=YYrXuyrTcIY" method="post">
              <h3>Sign In</h3>
              ...
              <div class="form-group row">
                ...
                <div class="col-12 col-md-auto ml-md-auto text-md-right">
                    <a href="/auth/realms/CloudUsers/login-actions/reset-credentials?client_id=auth-proxy&amp;tab_id=YYrXuyrTcIY" class="forgot-password">Forgot Password?</a>
                </div>
              </div>
              ...
              <div id="kc-form-buttons" class="form-group">
               <input tabindex="4" class="btn btn-primary btn-block btn-lg" name="login" id="kc-login" type="submit" value="Sign In"/>
                ...
                <div class="form-group or-separator">
                  ...
                  <div class="form-group">
                    <a class="btn btn-outline-primary btn-block" href="/auth/realms/CloudUsers/broker/google/login?client_id=auth-proxy&amp;tab_id=YYrXuyrTcIY&amp;session_code=KUmGgAlttnh8ew0NxvKAs7t9wE9OxNIL8dgfEhhB7gY" id="zocial-google">
                       <img src="/auth/resources/5cigl/login/cloud/img/google-icon.svg" alt="google icon">
                       Sign In with Google
                    </a>
                  </div>
                  <div class="form-group">
                    <a class="btn btn-outline-primary btn-block" href="/auth/realms/CloudUsers/broker/github/login?client_id=auth-proxy&amp;tab_id=YYrXuyrTcIY&amp;session_code=KUmGgAlttnh8ew0NxvKAs7t9wE9OxNIL8dgfEhhB7gY" id="zocial-github">
